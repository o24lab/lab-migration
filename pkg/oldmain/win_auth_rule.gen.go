...
func newWinAuthRule(db *gorm.DB, opts ...gen.DOOption) winAuthRule {
	...
	_winAuthRule.ID = field.NewInt32(tableName, "id")
	...
	_winAuthRule.Pid = field.NewInt32(tableName, "pid")
	_winAuthRule.IsMenu = field.NewInt32(tableName, "is_menu")
	_winAuthRule.IsRaceMenu = field.NewInt32(tableName, "is_race_menu")
	_winAuthRule.Status = field.NewInt32(tableName, "status")
	_winAuthRule.CreatedAt = field.NewInt32(tableName, "created_at")
	_winAuthRule.UpdatedAt = field.NewInt32(tableName, "updated_at")
...
type winAuthRule struct {
	...
	Pid          field.Int32  // 父节点ID
	IsMenu       field.Int32  // 是否主菜单:1-是 0-否
	IsRaceMenu   field.Int32  // 是否按钮:1-是 0-否
...
func (w *winAuthRule) updateTableName(table string) *winAuthRule {
	...
	w.IsMenu = field.NewInt32(table, "is_menu")
	w.IsRaceMenu = field.NewInt32(table, "is_race_menu")
...
func (w winAuthRuleDo) Debug() *winAuthRuleDo {
	return w.withDO(w.DO.Debug())
}

func (w winAuthRuleDo) WithContext(ctx context.Context) *winAuthRuleDo {
	return w.withDO(w.DO.WithContext(ctx))
}

func (w winAuthRuleDo) ReadDB() *winAuthRuleDo {
	return w.Clauses(dbresolver.Read)
}

func (w winAuthRuleDo) WriteDB() *winAuthRuleDo {
	return w.Clauses(dbresolver.Write)
}

func (w winAuthRuleDo) Session(config *gorm.Session) *winAuthRuleDo {
	return w.withDO(w.DO.Session(config))
}

func (w winAuthRuleDo) Clauses(conds ...clause.Expression) *winAuthRuleDo {
	return w.withDO(w.DO.Clauses(conds...))
}

func (w winAuthRuleDo) Returning(value interface{}, columns ...string) *winAuthRuleDo {
	return w.withDO(w.DO.Returning(value, columns...))
}

func (w winAuthRuleDo) Not(conds ...gen.Condition) *winAuthRuleDo {
	return w.withDO(w.DO.Not(conds...))
}

func (w winAuthRuleDo) Or(conds ...gen.Condition) *winAuthRuleDo {
	return w.withDO(w.DO.Or(conds...))
}

func (w winAuthRuleDo) Select(conds ...field.Expr) *winAuthRuleDo {
	return w.withDO(w.DO.Select(conds...))
}

func (w winAuthRuleDo) Where(conds ...gen.Condition) *winAuthRuleDo {
	return w.withDO(w.DO.Where(conds...))
}

func (w winAuthRuleDo) Order(conds ...field.Expr) *winAuthRuleDo {
	return w.withDO(w.DO.Order(conds...))
}

func (w winAuthRuleDo) Distinct(cols ...field.Expr) *winAuthRuleDo {
	return w.withDO(w.DO.Distinct(cols...))
}

func (w winAuthRuleDo) Omit(cols ...field.Expr) *winAuthRuleDo {
	return w.withDO(w.DO.Omit(cols...))
}

func (w winAuthRuleDo) Join(table schema.Tabler, on ...field.Expr) *winAuthRuleDo {
	return w.withDO(w.DO.Join(table, on...))
}

func (w winAuthRuleDo) LeftJoin(table schema.Tabler, on ...field.Expr) *winAuthRuleDo {
	return w.withDO(w.DO.LeftJoin(table, on...))
}

func (w winAuthRuleDo) RightJoin(table schema.Tabler, on ...field.Expr) *winAuthRuleDo {
	return w.withDO(w.DO.RightJoin(table, on...))
}

func (w winAuthRuleDo) Group(cols ...field.Expr) *winAuthRuleDo {
	return w.withDO(w.DO.Group(cols...))
}

func (w winAuthRuleDo) Having(conds ...gen.Condition) *winAuthRuleDo {
	return w.withDO(w.DO.Having(conds...))
}

func (w winAuthRuleDo) Limit(limit int) *winAuthRuleDo {
	return w.withDO(w.DO.Limit(limit))
}

func (w winAuthRuleDo) Offset(offset int) *winAuthRuleDo {
	return w.withDO(w.DO.Offset(offset))
}

func (w winAuthRuleDo) Scopes(funcs ...func(gen.Dao) gen.Dao) *winAuthRuleDo {
	return w.withDO(w.DO.Scopes(funcs...))
}

func (w winAuthRuleDo) Unscoped() *winAuthRuleDo {
...
func (w winAuthRuleDo) Attrs(attrs ...field.AssignExpr) *winAuthRuleDo {
	return w.withDO(w.DO.Attrs(attrs...))
}

func (w winAuthRuleDo) Assign(attrs ...field.AssignExpr) *winAuthRuleDo {
	return w.withDO(w.DO.Assign(attrs...))
}

func (w winAuthRuleDo) Joins(fields ...field.RelationField) *winAuthRuleDo {
...
func (w winAuthRuleDo) Preload(fields ...field.RelationField) *winAuthRuleDo {
	for _, _f := range fields {
