...
func newWinNotice(db *gorm.DB, opts ...gen.DOOption) winNotice {
	...
	_winNotice.Category = field.NewInt32(tableName, "category")
	_winNotice.Status = field.NewInt32(tableName, "status")
	_winNotice.Sort = field.NewInt32(tableName, "sort")
	_winNotice.CreatedAt = field.NewInt32(tableName, "created_at")
	_winNotice.UpdatedAt = field.NewInt32(tableName, "updated_at")
	_winNotice.OperatorName = field.NewString(tableName, "operator_name")
	_winNotice.UID = field.NewInt32(tableName, "uid")
...
func (w winNoticeDo) Debug() *winNoticeDo {
	return w.withDO(w.DO.Debug())
}

func (w winNoticeDo) WithContext(ctx context.Context) *winNoticeDo {
	return w.withDO(w.DO.WithContext(ctx))
}

func (w winNoticeDo) ReadDB() *winNoticeDo {
	return w.Clauses(dbresolver.Read)
}

func (w winNoticeDo) WriteDB() *winNoticeDo {
	return w.Clauses(dbresolver.Write)
}

func (w winNoticeDo) Session(config *gorm.Session) *winNoticeDo {
	return w.withDO(w.DO.Session(config))
}

func (w winNoticeDo) Clauses(conds ...clause.Expression) *winNoticeDo {
	return w.withDO(w.DO.Clauses(conds...))
}

func (w winNoticeDo) Returning(value interface{}, columns ...string) *winNoticeDo {
	return w.withDO(w.DO.Returning(value, columns...))
}

func (w winNoticeDo) Not(conds ...gen.Condition) *winNoticeDo {
	return w.withDO(w.DO.Not(conds...))
}

func (w winNoticeDo) Or(conds ...gen.Condition) *winNoticeDo {
	return w.withDO(w.DO.Or(conds...))
}

func (w winNoticeDo) Select(conds ...field.Expr) *winNoticeDo {
	return w.withDO(w.DO.Select(conds...))
}

func (w winNoticeDo) Where(conds ...gen.Condition) *winNoticeDo {
	return w.withDO(w.DO.Where(conds...))
}

func (w winNoticeDo) Order(conds ...field.Expr) *winNoticeDo {
	return w.withDO(w.DO.Order(conds...))
}

func (w winNoticeDo) Distinct(cols ...field.Expr) *winNoticeDo {
	return w.withDO(w.DO.Distinct(cols...))
}

func (w winNoticeDo) Omit(cols ...field.Expr) *winNoticeDo {
	return w.withDO(w.DO.Omit(cols...))
}

func (w winNoticeDo) Join(table schema.Tabler, on ...field.Expr) *winNoticeDo {
	return w.withDO(w.DO.Join(table, on...))
}

func (w winNoticeDo) LeftJoin(table schema.Tabler, on ...field.Expr) *winNoticeDo {
	return w.withDO(w.DO.LeftJoin(table, on...))
}

func (w winNoticeDo) RightJoin(table schema.Tabler, on ...field.Expr) *winNoticeDo {
	return w.withDO(w.DO.RightJoin(table, on...))
}

func (w winNoticeDo) Group(cols ...field.Expr) *winNoticeDo {
	return w.withDO(w.DO.Group(cols...))
}

func (w winNoticeDo) Having(conds ...gen.Condition) *winNoticeDo {
	return w.withDO(w.DO.Having(conds...))
}

func (w winNoticeDo) Limit(limit int) *winNoticeDo {
	return w.withDO(w.DO.Limit(limit))
}

func (w winNoticeDo) Offset(offset int) *winNoticeDo {
	return w.withDO(w.DO.Offset(offset))
}

func (w winNoticeDo) Scopes(funcs ...func(gen.Dao) gen.Dao) *winNoticeDo {
	return w.withDO(w.DO.Scopes(funcs...))
}

func (w winNoticeDo) Unscoped() *winNoticeDo {
...
func (w winNoticeDo) Attrs(attrs ...field.AssignExpr) *winNoticeDo {
	return w.withDO(w.DO.Attrs(attrs...))
}

func (w winNoticeDo) Assign(attrs ...field.AssignExpr) *winNoticeDo {
	return w.withDO(w.DO.Assign(attrs...))
}

func (w winNoticeDo) Joins(fields ...field.RelationField) *winNoticeDo {
...
func (w winNoticeDo) Preload(fields ...field.RelationField) *winNoticeDo {
	for _, _f := range fields {
