...
func newWinBetSlipsException(db *gorm.DB, opts ...gen.DOOption) winBetSlipsException {
	...
	_winBetSlipsException.GameListID = field.NewInt32(tableName, "game_list_id")
	_winBetSlipsException.Request = field.NewString(tableName, "request")
	_winBetSlipsException.Category = field.NewInt32(tableName, "category")
	_winBetSlipsException.Info = field.NewString(tableName, "info")
	_winBetSlipsException.Status = field.NewInt32(tableName, "status")
	_winBetSlipsException.CreatedAt = field.NewInt32(tableName, "created_at")
	_winBetSlipsException.UpdatedAt = field.NewInt32(tableName, "updated_at")
...
type winBetSlipsException struct {
	...
	ALL        field.Asterisk
	ID         field.Int64
	GameListID field.Int32  // 游戏表ID
	Request    field.String // 请求参数
	Category   field.Int32  // 状态:0-三方异常 1-数据异常
	Info       field.String // 异常信息:三方-返回数据 数据-异常处理
	Status     field.Int32  // 状态:0-未处理 1-处理成功 2-处理失败
...
func (w winBetSlipsExceptionDo) Debug() *winBetSlipsExceptionDo {
	return w.withDO(w.DO.Debug())
}

func (w winBetSlipsExceptionDo) WithContext(ctx context.Context) *winBetSlipsExceptionDo {
	return w.withDO(w.DO.WithContext(ctx))
}

func (w winBetSlipsExceptionDo) ReadDB() *winBetSlipsExceptionDo {
	return w.Clauses(dbresolver.Read)
}

func (w winBetSlipsExceptionDo) WriteDB() *winBetSlipsExceptionDo {
	return w.Clauses(dbresolver.Write)
}

func (w winBetSlipsExceptionDo) Session(config *gorm.Session) *winBetSlipsExceptionDo {
	return w.withDO(w.DO.Session(config))
}

func (w winBetSlipsExceptionDo) Clauses(conds ...clause.Expression) *winBetSlipsExceptionDo {
	return w.withDO(w.DO.Clauses(conds...))
}

func (w winBetSlipsExceptionDo) Returning(value interface{}, columns ...string) *winBetSlipsExceptionDo {
	return w.withDO(w.DO.Returning(value, columns...))
}

func (w winBetSlipsExceptionDo) Not(conds ...gen.Condition) *winBetSlipsExceptionDo {
	return w.withDO(w.DO.Not(conds...))
}

func (w winBetSlipsExceptionDo) Or(conds ...gen.Condition) *winBetSlipsExceptionDo {
	return w.withDO(w.DO.Or(conds...))
}

func (w winBetSlipsExceptionDo) Select(conds ...field.Expr) *winBetSlipsExceptionDo {
	return w.withDO(w.DO.Select(conds...))
}

func (w winBetSlipsExceptionDo) Where(conds ...gen.Condition) *winBetSlipsExceptionDo {
	return w.withDO(w.DO.Where(conds...))
}

func (w winBetSlipsExceptionDo) Order(conds ...field.Expr) *winBetSlipsExceptionDo {
	return w.withDO(w.DO.Order(conds...))
}

func (w winBetSlipsExceptionDo) Distinct(cols ...field.Expr) *winBetSlipsExceptionDo {
	return w.withDO(w.DO.Distinct(cols...))
}

func (w winBetSlipsExceptionDo) Omit(cols ...field.Expr) *winBetSlipsExceptionDo {
	return w.withDO(w.DO.Omit(cols...))
}

func (w winBetSlipsExceptionDo) Join(table schema.Tabler, on ...field.Expr) *winBetSlipsExceptionDo {
	return w.withDO(w.DO.Join(table, on...))
}

func (w winBetSlipsExceptionDo) LeftJoin(table schema.Tabler, on ...field.Expr) *winBetSlipsExceptionDo {
	return w.withDO(w.DO.LeftJoin(table, on...))
}

func (w winBetSlipsExceptionDo) RightJoin(table schema.Tabler, on ...field.Expr) *winBetSlipsExceptionDo {
	return w.withDO(w.DO.RightJoin(table, on...))
}

func (w winBetSlipsExceptionDo) Group(cols ...field.Expr) *winBetSlipsExceptionDo {
	return w.withDO(w.DO.Group(cols...))
}

func (w winBetSlipsExceptionDo) Having(conds ...gen.Condition) *winBetSlipsExceptionDo {
	return w.withDO(w.DO.Having(conds...))
}

func (w winBetSlipsExceptionDo) Limit(limit int) *winBetSlipsExceptionDo {
	return w.withDO(w.DO.Limit(limit))
}

func (w winBetSlipsExceptionDo) Offset(offset int) *winBetSlipsExceptionDo {
	return w.withDO(w.DO.Offset(offset))
}

func (w winBetSlipsExceptionDo) Scopes(funcs ...func(gen.Dao) gen.Dao) *winBetSlipsExceptionDo {
	return w.withDO(w.DO.Scopes(funcs...))
}

func (w winBetSlipsExceptionDo) Unscoped() *winBetSlipsExceptionDo {
...
func (w winBetSlipsExceptionDo) Attrs(attrs ...field.AssignExpr) *winBetSlipsExceptionDo {
	return w.withDO(w.DO.Attrs(attrs...))
}

func (w winBetSlipsExceptionDo) Assign(attrs ...field.AssignExpr) *winBetSlipsExceptionDo {
	return w.withDO(w.DO.Assign(attrs...))
}

func (w winBetSlipsExceptionDo) Joins(fields ...field.RelationField) *winBetSlipsExceptionDo {
...
func (w winBetSlipsExceptionDo) Preload(fields ...field.RelationField) *winBetSlipsExceptionDo {
	for _, _f := range fields {
