...
func newWinMqError(db *gorm.DB, opts ...gen.DOOption) winMqError {
	...
	_winMqError.Status = field.NewInt32(tableName, "status")
...
type winMqError struct {
	...
	Status        field.Int32  // 0-未处理,1-已处理,2-忽略
...
func (w winMqErrorDo) Debug() *winMqErrorDo {
	return w.withDO(w.DO.Debug())
}

func (w winMqErrorDo) WithContext(ctx context.Context) *winMqErrorDo {
	return w.withDO(w.DO.WithContext(ctx))
}

func (w winMqErrorDo) ReadDB() *winMqErrorDo {
	return w.Clauses(dbresolver.Read)
}

func (w winMqErrorDo) WriteDB() *winMqErrorDo {
	return w.Clauses(dbresolver.Write)
}

func (w winMqErrorDo) Session(config *gorm.Session) *winMqErrorDo {
	return w.withDO(w.DO.Session(config))
}

func (w winMqErrorDo) Clauses(conds ...clause.Expression) *winMqErrorDo {
	return w.withDO(w.DO.Clauses(conds...))
}

func (w winMqErrorDo) Returning(value interface{}, columns ...string) *winMqErrorDo {
	return w.withDO(w.DO.Returning(value, columns...))
}

func (w winMqErrorDo) Not(conds ...gen.Condition) *winMqErrorDo {
	return w.withDO(w.DO.Not(conds...))
}

func (w winMqErrorDo) Or(conds ...gen.Condition) *winMqErrorDo {
	return w.withDO(w.DO.Or(conds...))
}

func (w winMqErrorDo) Select(conds ...field.Expr) *winMqErrorDo {
	return w.withDO(w.DO.Select(conds...))
}

func (w winMqErrorDo) Where(conds ...gen.Condition) *winMqErrorDo {
	return w.withDO(w.DO.Where(conds...))
}

func (w winMqErrorDo) Order(conds ...field.Expr) *winMqErrorDo {
	return w.withDO(w.DO.Order(conds...))
}

func (w winMqErrorDo) Distinct(cols ...field.Expr) *winMqErrorDo {
	return w.withDO(w.DO.Distinct(cols...))
}

func (w winMqErrorDo) Omit(cols ...field.Expr) *winMqErrorDo {
	return w.withDO(w.DO.Omit(cols...))
}

func (w winMqErrorDo) Join(table schema.Tabler, on ...field.Expr) *winMqErrorDo {
	return w.withDO(w.DO.Join(table, on...))
}

func (w winMqErrorDo) LeftJoin(table schema.Tabler, on ...field.Expr) *winMqErrorDo {
	return w.withDO(w.DO.LeftJoin(table, on...))
}

func (w winMqErrorDo) RightJoin(table schema.Tabler, on ...field.Expr) *winMqErrorDo {
	return w.withDO(w.DO.RightJoin(table, on...))
}

func (w winMqErrorDo) Group(cols ...field.Expr) *winMqErrorDo {
	return w.withDO(w.DO.Group(cols...))
}

func (w winMqErrorDo) Having(conds ...gen.Condition) *winMqErrorDo {
	return w.withDO(w.DO.Having(conds...))
}

func (w winMqErrorDo) Limit(limit int) *winMqErrorDo {
	return w.withDO(w.DO.Limit(limit))
}

func (w winMqErrorDo) Offset(offset int) *winMqErrorDo {
	return w.withDO(w.DO.Offset(offset))
}

func (w winMqErrorDo) Scopes(funcs ...func(gen.Dao) gen.Dao) *winMqErrorDo {
	return w.withDO(w.DO.Scopes(funcs...))
}

func (w winMqErrorDo) Unscoped() *winMqErrorDo {
...
func (w winMqErrorDo) Attrs(attrs ...field.AssignExpr) *winMqErrorDo {
	return w.withDO(w.DO.Attrs(attrs...))
}

func (w winMqErrorDo) Assign(attrs ...field.AssignExpr) *winMqErrorDo {
	return w.withDO(w.DO.Assign(attrs...))
}

func (w winMqErrorDo) Joins(fields ...field.RelationField) *winMqErrorDo {
...
func (w winMqErrorDo) Preload(fields ...field.RelationField) *winMqErrorDo {
	for _, _f := range fields {
