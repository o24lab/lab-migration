...
func newWinFrontGameBigCategoryBanner(db *gorm.DB, opts ...gen.DOOption) winFrontGameBigCategoryBanner {
	...
	_winFrontGameBigCategoryBanner.ID = field.NewInt32(tableName, "id")
	...
	_winFrontGameBigCategoryBanner.GameGroupID = field.NewInt32(tableName, "game_group_id")
	_winFrontGameBigCategoryBanner.Sort = field.NewInt32(tableName, "sort")
	_winFrontGameBigCategoryBanner.Status = field.NewInt32(tableName, "status")
	_winFrontGameBigCategoryBanner.CreatedAt = field.NewInt32(tableName, "created_at")
	_winFrontGameBigCategoryBanner.CreatedBy = field.NewString(tableName, "created_by")
	_winFrontGameBigCategoryBanner.UpdatedAt = field.NewInt32(tableName, "updated_at")
...
type winFrontGameBigCategoryBanner struct {
	...
	GameGroupID field.Int32  // 游戏大类id
	Sort        field.Int32  // 排序字段
...
func (w winFrontGameBigCategoryBannerDo) Debug() *winFrontGameBigCategoryBannerDo {
	return w.withDO(w.DO.Debug())
}

func (w winFrontGameBigCategoryBannerDo) WithContext(ctx context.Context) *winFrontGameBigCategoryBannerDo {
	return w.withDO(w.DO.WithContext(ctx))
}

func (w winFrontGameBigCategoryBannerDo) ReadDB() *winFrontGameBigCategoryBannerDo {
	return w.Clauses(dbresolver.Read)
}

func (w winFrontGameBigCategoryBannerDo) WriteDB() *winFrontGameBigCategoryBannerDo {
	return w.Clauses(dbresolver.Write)
}

func (w winFrontGameBigCategoryBannerDo) Session(config *gorm.Session) *winFrontGameBigCategoryBannerDo {
	return w.withDO(w.DO.Session(config))
}

func (w winFrontGameBigCategoryBannerDo) Clauses(conds ...clause.Expression) *winFrontGameBigCategoryBannerDo {
	return w.withDO(w.DO.Clauses(conds...))
}

func (w winFrontGameBigCategoryBannerDo) Returning(value interface{}, columns ...string) *winFrontGameBigCategoryBannerDo {
	return w.withDO(w.DO.Returning(value, columns...))
}

func (w winFrontGameBigCategoryBannerDo) Not(conds ...gen.Condition) *winFrontGameBigCategoryBannerDo {
	return w.withDO(w.DO.Not(conds...))
}

func (w winFrontGameBigCategoryBannerDo) Or(conds ...gen.Condition) *winFrontGameBigCategoryBannerDo {
	return w.withDO(w.DO.Or(conds...))
}

func (w winFrontGameBigCategoryBannerDo) Select(conds ...field.Expr) *winFrontGameBigCategoryBannerDo {
	return w.withDO(w.DO.Select(conds...))
}

func (w winFrontGameBigCategoryBannerDo) Where(conds ...gen.Condition) *winFrontGameBigCategoryBannerDo {
	return w.withDO(w.DO.Where(conds...))
}

func (w winFrontGameBigCategoryBannerDo) Order(conds ...field.Expr) *winFrontGameBigCategoryBannerDo {
	return w.withDO(w.DO.Order(conds...))
}

func (w winFrontGameBigCategoryBannerDo) Distinct(cols ...field.Expr) *winFrontGameBigCategoryBannerDo {
	return w.withDO(w.DO.Distinct(cols...))
}

func (w winFrontGameBigCategoryBannerDo) Omit(cols ...field.Expr) *winFrontGameBigCategoryBannerDo {
	return w.withDO(w.DO.Omit(cols...))
}

func (w winFrontGameBigCategoryBannerDo) Join(table schema.Tabler, on ...field.Expr) *winFrontGameBigCategoryBannerDo {
	return w.withDO(w.DO.Join(table, on...))
}

func (w winFrontGameBigCategoryBannerDo) LeftJoin(table schema.Tabler, on ...field.Expr) *winFrontGameBigCategoryBannerDo {
	return w.withDO(w.DO.LeftJoin(table, on...))
}

func (w winFrontGameBigCategoryBannerDo) RightJoin(table schema.Tabler, on ...field.Expr) *winFrontGameBigCategoryBannerDo {
	return w.withDO(w.DO.RightJoin(table, on...))
}

func (w winFrontGameBigCategoryBannerDo) Group(cols ...field.Expr) *winFrontGameBigCategoryBannerDo {
	return w.withDO(w.DO.Group(cols...))
}

func (w winFrontGameBigCategoryBannerDo) Having(conds ...gen.Condition) *winFrontGameBigCategoryBannerDo {
	return w.withDO(w.DO.Having(conds...))
}

func (w winFrontGameBigCategoryBannerDo) Limit(limit int) *winFrontGameBigCategoryBannerDo {
	return w.withDO(w.DO.Limit(limit))
}

func (w winFrontGameBigCategoryBannerDo) Offset(offset int) *winFrontGameBigCategoryBannerDo {
	return w.withDO(w.DO.Offset(offset))
}

func (w winFrontGameBigCategoryBannerDo) Scopes(funcs ...func(gen.Dao) gen.Dao) *winFrontGameBigCategoryBannerDo {
	return w.withDO(w.DO.Scopes(funcs...))
}

func (w winFrontGameBigCategoryBannerDo) Unscoped() *winFrontGameBigCategoryBannerDo {
...
func (w winFrontGameBigCategoryBannerDo) Attrs(attrs ...field.AssignExpr) *winFrontGameBigCategoryBannerDo {
	return w.withDO(w.DO.Attrs(attrs...))
}

func (w winFrontGameBigCategoryBannerDo) Assign(attrs ...field.AssignExpr) *winFrontGameBigCategoryBannerDo {
	return w.withDO(w.DO.Assign(attrs...))
}

func (w winFrontGameBigCategoryBannerDo) Joins(fields ...field.RelationField) *winFrontGameBigCategoryBannerDo {
...
func (w winFrontGameBigCategoryBannerDo) Preload(fields ...field.RelationField) *winFrontGameBigCategoryBannerDo {
	for _, _f := range fields {
