...
func newWinCodeAudit(db *gorm.DB, opts ...gen.DOOption) winCodeAudit {
	...
	_winCodeAudit.ID = field.NewInt32(tableName, "id")
	_winCodeAudit.UID = field.NewInt32(tableName, "uid")
	...
	_winCodeAudit.CodeRequire = field.NewFloat64(tableName, "code_require")
	_winCodeAudit.CodeReal = field.NewFloat64(tableName, "code_real")
	_winCodeAudit.ReferID = field.NewInt64(tableName, "refer_id")
	_winCodeAudit.Status = field.NewInt32(tableName, "status")
	_winCodeAudit.CreatedAt = field.NewInt32(tableName, "created_at")
	_winCodeAudit.UpdatedAt = field.NewInt32(tableName, "updated_at")
...
type winCodeAudit struct {
	...
	CodeReal      field.Float64 // 真实打码量
	ReferID       field.Int64   // 对应的提款订单ID
	Status        field.Int32   // 状态:1-稽核成功 2-稽核失败
...
func (w *winCodeAudit) updateTableName(table string) *winCodeAudit {
	...
	w.CodeReal = field.NewFloat64(table, "code_real")
...
func (w winCodeAuditDo) Debug() *winCodeAuditDo {
	return w.withDO(w.DO.Debug())
}

func (w winCodeAuditDo) WithContext(ctx context.Context) *winCodeAuditDo {
	return w.withDO(w.DO.WithContext(ctx))
}

func (w winCodeAuditDo) ReadDB() *winCodeAuditDo {
	return w.Clauses(dbresolver.Read)
}

func (w winCodeAuditDo) WriteDB() *winCodeAuditDo {
	return w.Clauses(dbresolver.Write)
}

func (w winCodeAuditDo) Session(config *gorm.Session) *winCodeAuditDo {
	return w.withDO(w.DO.Session(config))
}

func (w winCodeAuditDo) Clauses(conds ...clause.Expression) *winCodeAuditDo {
	return w.withDO(w.DO.Clauses(conds...))
}

func (w winCodeAuditDo) Returning(value interface{}, columns ...string) *winCodeAuditDo {
	return w.withDO(w.DO.Returning(value, columns...))
}

func (w winCodeAuditDo) Not(conds ...gen.Condition) *winCodeAuditDo {
	return w.withDO(w.DO.Not(conds...))
}

func (w winCodeAuditDo) Or(conds ...gen.Condition) *winCodeAuditDo {
	return w.withDO(w.DO.Or(conds...))
}

func (w winCodeAuditDo) Select(conds ...field.Expr) *winCodeAuditDo {
	return w.withDO(w.DO.Select(conds...))
}

func (w winCodeAuditDo) Where(conds ...gen.Condition) *winCodeAuditDo {
	return w.withDO(w.DO.Where(conds...))
}

func (w winCodeAuditDo) Order(conds ...field.Expr) *winCodeAuditDo {
	return w.withDO(w.DO.Order(conds...))
}

func (w winCodeAuditDo) Distinct(cols ...field.Expr) *winCodeAuditDo {
	return w.withDO(w.DO.Distinct(cols...))
}

func (w winCodeAuditDo) Omit(cols ...field.Expr) *winCodeAuditDo {
	return w.withDO(w.DO.Omit(cols...))
}

func (w winCodeAuditDo) Join(table schema.Tabler, on ...field.Expr) *winCodeAuditDo {
	return w.withDO(w.DO.Join(table, on...))
}

func (w winCodeAuditDo) LeftJoin(table schema.Tabler, on ...field.Expr) *winCodeAuditDo {
	return w.withDO(w.DO.LeftJoin(table, on...))
}

func (w winCodeAuditDo) RightJoin(table schema.Tabler, on ...field.Expr) *winCodeAuditDo {
	return w.withDO(w.DO.RightJoin(table, on...))
}

func (w winCodeAuditDo) Group(cols ...field.Expr) *winCodeAuditDo {
	return w.withDO(w.DO.Group(cols...))
}

func (w winCodeAuditDo) Having(conds ...gen.Condition) *winCodeAuditDo {
	return w.withDO(w.DO.Having(conds...))
}

func (w winCodeAuditDo) Limit(limit int) *winCodeAuditDo {
	return w.withDO(w.DO.Limit(limit))
}

func (w winCodeAuditDo) Offset(offset int) *winCodeAuditDo {
	return w.withDO(w.DO.Offset(offset))
}

func (w winCodeAuditDo) Scopes(funcs ...func(gen.Dao) gen.Dao) *winCodeAuditDo {
	return w.withDO(w.DO.Scopes(funcs...))
}

func (w winCodeAuditDo) Unscoped() *winCodeAuditDo {
...
func (w winCodeAuditDo) Attrs(attrs ...field.AssignExpr) *winCodeAuditDo {
	return w.withDO(w.DO.Attrs(attrs...))
}

func (w winCodeAuditDo) Assign(attrs ...field.AssignExpr) *winCodeAuditDo {
	return w.withDO(w.DO.Assign(attrs...))
}

func (w winCodeAuditDo) Joins(fields ...field.RelationField) *winCodeAuditDo {
...
func (w winCodeAuditDo) Preload(fields ...field.RelationField) *winCodeAuditDo {
	for _, _f := range fields {
