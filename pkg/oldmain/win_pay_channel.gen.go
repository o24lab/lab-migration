...
func newWinPayChannel(db *gorm.DB, opts ...gen.DOOption) winPayChannel {
	...
	_winPayChannel.Category = field.NewInt32(tableName, "category")
	_winPayChannel.CategoryTransfer = field.NewInt32(tableName, "category_transfer")
	_winPayChannel.CategoryCurrency = field.NewInt32(tableName, "category_currency")
	_winPayChannel.MinCoin = field.NewInt32(tableName, "min_coin")
	_winPayChannel.MaxCoin = field.NewInt32(tableName, "max_coin")
	_winPayChannel.Status = field.NewInt32(tableName, "status")
	...
	_winPayChannel.CreatedAt = field.NewInt32(tableName, "created_at")
	_winPayChannel.UpdatedAt = field.NewInt32(tableName, "updated_at")
	_winPayChannel.Sort = field.NewInt32(tableName, "sort")
...
type winPayChannel struct {
	...
	PlatID             field.Int32  // 平台ID
	PlatName           field.String // 平台名称
	PlatNickName       field.String // 平台自定义名称
	Category           field.Int32  // 支付类型；1:代收 2:代付
	CategoryTransfer   field.Int32  // 转账类型：1-TRC,2-ERC,3-BANK,4-PIX,5-GCASH
	CategoryCurrency   field.Int32  // 提款货币类型:0-数字货币 1-法币方式;1:USDT 2:Bank Card
	MinCoin            field.Int32  // 最小金额
	MaxCoin            field.Int32  // 最大金额
...
func (w *winPayChannel) updateTableName(table string) *winPayChannel {
	...
	w.MinCoin = field.NewInt32(table, "min_coin")
	w.MaxCoin = field.NewInt32(table, "max_coin")
...
func (w winPayChannelDo) Debug() *winPayChannelDo {
	return w.withDO(w.DO.Debug())
}

func (w winPayChannelDo) WithContext(ctx context.Context) *winPayChannelDo {
	return w.withDO(w.DO.WithContext(ctx))
}

func (w winPayChannelDo) ReadDB() *winPayChannelDo {
	return w.Clauses(dbresolver.Read)
}

func (w winPayChannelDo) WriteDB() *winPayChannelDo {
	return w.Clauses(dbresolver.Write)
}

func (w winPayChannelDo) Session(config *gorm.Session) *winPayChannelDo {
	return w.withDO(w.DO.Session(config))
}

func (w winPayChannelDo) Clauses(conds ...clause.Expression) *winPayChannelDo {
	return w.withDO(w.DO.Clauses(conds...))
}

func (w winPayChannelDo) Returning(value interface{}, columns ...string) *winPayChannelDo {
	return w.withDO(w.DO.Returning(value, columns...))
}

func (w winPayChannelDo) Not(conds ...gen.Condition) *winPayChannelDo {
	return w.withDO(w.DO.Not(conds...))
}

func (w winPayChannelDo) Or(conds ...gen.Condition) *winPayChannelDo {
	return w.withDO(w.DO.Or(conds...))
}

func (w winPayChannelDo) Select(conds ...field.Expr) *winPayChannelDo {
	return w.withDO(w.DO.Select(conds...))
}

func (w winPayChannelDo) Where(conds ...gen.Condition) *winPayChannelDo {
	return w.withDO(w.DO.Where(conds...))
}

func (w winPayChannelDo) Order(conds ...field.Expr) *winPayChannelDo {
	return w.withDO(w.DO.Order(conds...))
}

func (w winPayChannelDo) Distinct(cols ...field.Expr) *winPayChannelDo {
	return w.withDO(w.DO.Distinct(cols...))
}

func (w winPayChannelDo) Omit(cols ...field.Expr) *winPayChannelDo {
	return w.withDO(w.DO.Omit(cols...))
}

func (w winPayChannelDo) Join(table schema.Tabler, on ...field.Expr) *winPayChannelDo {
	return w.withDO(w.DO.Join(table, on...))
}

func (w winPayChannelDo) LeftJoin(table schema.Tabler, on ...field.Expr) *winPayChannelDo {
	return w.withDO(w.DO.LeftJoin(table, on...))
}

func (w winPayChannelDo) RightJoin(table schema.Tabler, on ...field.Expr) *winPayChannelDo {
	return w.withDO(w.DO.RightJoin(table, on...))
}

func (w winPayChannelDo) Group(cols ...field.Expr) *winPayChannelDo {
	return w.withDO(w.DO.Group(cols...))
}

func (w winPayChannelDo) Having(conds ...gen.Condition) *winPayChannelDo {
	return w.withDO(w.DO.Having(conds...))
}

func (w winPayChannelDo) Limit(limit int) *winPayChannelDo {
	return w.withDO(w.DO.Limit(limit))
}

func (w winPayChannelDo) Offset(offset int) *winPayChannelDo {
	return w.withDO(w.DO.Offset(offset))
}

func (w winPayChannelDo) Scopes(funcs ...func(gen.Dao) gen.Dao) *winPayChannelDo {
	return w.withDO(w.DO.Scopes(funcs...))
}

func (w winPayChannelDo) Unscoped() *winPayChannelDo {
...
func (w winPayChannelDo) Attrs(attrs ...field.AssignExpr) *winPayChannelDo {
	return w.withDO(w.DO.Attrs(attrs...))
}

func (w winPayChannelDo) Assign(attrs ...field.AssignExpr) *winPayChannelDo {
	return w.withDO(w.DO.Assign(attrs...))
}

func (w winPayChannelDo) Joins(fields ...field.RelationField) *winPayChannelDo {
...
func (w winPayChannelDo) Preload(fields ...field.RelationField) *winPayChannelDo {
	for _, _f := range fields {
