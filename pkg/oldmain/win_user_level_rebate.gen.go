...
func newWinUserLevelRebate(db *gorm.DB, opts ...gen.DOOption) winUserLevelRebate {
	...
	_winUserLevelRebate.ID = field.NewInt32(tableName, "id")
	_winUserLevelRebate.LevelID = field.NewInt32(tableName, "level_id")
	_winUserLevelRebate.GroupID = field.NewInt32(tableName, "group_id")
	_winUserLevelRebate.RebateRate = field.NewFloat64(tableName, "rebate_rate")
	_winUserLevelRebate.Status = field.NewInt32(tableName, "status")
	_winUserLevelRebate.CreatedAt = field.NewInt32(tableName, "created_at")
	_winUserLevelRebate.UpdatedAt = field.NewInt32(tableName, "updated_at")
...
func (w winUserLevelRebateDo) Debug() *winUserLevelRebateDo {
	return w.withDO(w.DO.Debug())
}

func (w winUserLevelRebateDo) WithContext(ctx context.Context) *winUserLevelRebateDo {
	return w.withDO(w.DO.WithContext(ctx))
}

func (w winUserLevelRebateDo) ReadDB() *winUserLevelRebateDo {
	return w.Clauses(dbresolver.Read)
}

func (w winUserLevelRebateDo) WriteDB() *winUserLevelRebateDo {
	return w.Clauses(dbresolver.Write)
}

func (w winUserLevelRebateDo) Session(config *gorm.Session) *winUserLevelRebateDo {
	return w.withDO(w.DO.Session(config))
}

func (w winUserLevelRebateDo) Clauses(conds ...clause.Expression) *winUserLevelRebateDo {
	return w.withDO(w.DO.Clauses(conds...))
}

func (w winUserLevelRebateDo) Returning(value interface{}, columns ...string) *winUserLevelRebateDo {
	return w.withDO(w.DO.Returning(value, columns...))
}

func (w winUserLevelRebateDo) Not(conds ...gen.Condition) *winUserLevelRebateDo {
	return w.withDO(w.DO.Not(conds...))
}

func (w winUserLevelRebateDo) Or(conds ...gen.Condition) *winUserLevelRebateDo {
	return w.withDO(w.DO.Or(conds...))
}

func (w winUserLevelRebateDo) Select(conds ...field.Expr) *winUserLevelRebateDo {
	return w.withDO(w.DO.Select(conds...))
}

func (w winUserLevelRebateDo) Where(conds ...gen.Condition) *winUserLevelRebateDo {
	return w.withDO(w.DO.Where(conds...))
}

func (w winUserLevelRebateDo) Order(conds ...field.Expr) *winUserLevelRebateDo {
	return w.withDO(w.DO.Order(conds...))
}

func (w winUserLevelRebateDo) Distinct(cols ...field.Expr) *winUserLevelRebateDo {
	return w.withDO(w.DO.Distinct(cols...))
}

func (w winUserLevelRebateDo) Omit(cols ...field.Expr) *winUserLevelRebateDo {
	return w.withDO(w.DO.Omit(cols...))
}

func (w winUserLevelRebateDo) Join(table schema.Tabler, on ...field.Expr) *winUserLevelRebateDo {
	return w.withDO(w.DO.Join(table, on...))
}

func (w winUserLevelRebateDo) LeftJoin(table schema.Tabler, on ...field.Expr) *winUserLevelRebateDo {
	return w.withDO(w.DO.LeftJoin(table, on...))
}

func (w winUserLevelRebateDo) RightJoin(table schema.Tabler, on ...field.Expr) *winUserLevelRebateDo {
	return w.withDO(w.DO.RightJoin(table, on...))
}

func (w winUserLevelRebateDo) Group(cols ...field.Expr) *winUserLevelRebateDo {
	return w.withDO(w.DO.Group(cols...))
}

func (w winUserLevelRebateDo) Having(conds ...gen.Condition) *winUserLevelRebateDo {
	return w.withDO(w.DO.Having(conds...))
}

func (w winUserLevelRebateDo) Limit(limit int) *winUserLevelRebateDo {
	return w.withDO(w.DO.Limit(limit))
}

func (w winUserLevelRebateDo) Offset(offset int) *winUserLevelRebateDo {
	return w.withDO(w.DO.Offset(offset))
}

func (w winUserLevelRebateDo) Scopes(funcs ...func(gen.Dao) gen.Dao) *winUserLevelRebateDo {
	return w.withDO(w.DO.Scopes(funcs...))
}

func (w winUserLevelRebateDo) Unscoped() *winUserLevelRebateDo {
...
func (w winUserLevelRebateDo) Attrs(attrs ...field.AssignExpr) *winUserLevelRebateDo {
	return w.withDO(w.DO.Attrs(attrs...))
}

func (w winUserLevelRebateDo) Assign(attrs ...field.AssignExpr) *winUserLevelRebateDo {
	return w.withDO(w.DO.Assign(attrs...))
}

func (w winUserLevelRebateDo) Joins(fields ...field.RelationField) *winUserLevelRebateDo {
...
func (w winUserLevelRebateDo) Preload(fields ...field.RelationField) *winUserLevelRebateDo {
	for _, _f := range fields {
