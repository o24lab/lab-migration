...
func newWinAdminExportFileTask(db *gorm.DB, opts ...gen.DOOption) winAdminExportFileTask {
	...
	_winAdminExportFileTask.StatusCode = field.NewInt32(tableName, "status_code")
	...
	_winAdminExportFileTask.FilePathHash = field.NewInt32(tableName, "file_path_hash")
	_winAdminExportFileTask.OperatorID = field.NewInt32(tableName, "operator_id")
	_winAdminExportFileTask.CreatedAt = field.NewInt32(tableName, "created_at")
	_winAdminExportFileTask.UpdatedAt = field.NewInt32(tableName, "updated_at")
...
type winAdminExportFileTask struct {
	...
	StatusCode   field.Int32  // 导出状态码，2=处理中，3=文件已生成，5=失败
	StatusMess   field.String // 导出状态信息
	FilePath     field.String // 文件路径
	FilePathHash field.Int32  // 文件路径hash
...
func (w *winAdminExportFileTask) updateTableName(table string) *winAdminExportFileTask {
	...
	w.StatusCode = field.NewInt32(table, "status_code")
	w.StatusMess = field.NewString(table, "status_mess")
	w.FilePath = field.NewString(table, "file_path")
	w.FilePathHash = field.NewInt32(table, "file_path_hash")
	w.OperatorID = field.NewInt32(table, "operator_id")
...
func (w winAdminExportFileTaskDo) Debug() *winAdminExportFileTaskDo {
	return w.withDO(w.DO.Debug())
}

func (w winAdminExportFileTaskDo) WithContext(ctx context.Context) *winAdminExportFileTaskDo {
	return w.withDO(w.DO.WithContext(ctx))
}

func (w winAdminExportFileTaskDo) ReadDB() *winAdminExportFileTaskDo {
	return w.Clauses(dbresolver.Read)
}

func (w winAdminExportFileTaskDo) WriteDB() *winAdminExportFileTaskDo {
	return w.Clauses(dbresolver.Write)
}

func (w winAdminExportFileTaskDo) Session(config *gorm.Session) *winAdminExportFileTaskDo {
	return w.withDO(w.DO.Session(config))
}

func (w winAdminExportFileTaskDo) Clauses(conds ...clause.Expression) *winAdminExportFileTaskDo {
	return w.withDO(w.DO.Clauses(conds...))
}

func (w winAdminExportFileTaskDo) Returning(value interface{}, columns ...string) *winAdminExportFileTaskDo {
	return w.withDO(w.DO.Returning(value, columns...))
}

func (w winAdminExportFileTaskDo) Not(conds ...gen.Condition) *winAdminExportFileTaskDo {
	return w.withDO(w.DO.Not(conds...))
}

func (w winAdminExportFileTaskDo) Or(conds ...gen.Condition) *winAdminExportFileTaskDo {
	return w.withDO(w.DO.Or(conds...))
}

func (w winAdminExportFileTaskDo) Select(conds ...field.Expr) *winAdminExportFileTaskDo {
	return w.withDO(w.DO.Select(conds...))
}

func (w winAdminExportFileTaskDo) Where(conds ...gen.Condition) *winAdminExportFileTaskDo {
	return w.withDO(w.DO.Where(conds...))
}

func (w winAdminExportFileTaskDo) Order(conds ...field.Expr) *winAdminExportFileTaskDo {
	return w.withDO(w.DO.Order(conds...))
}

func (w winAdminExportFileTaskDo) Distinct(cols ...field.Expr) *winAdminExportFileTaskDo {
	return w.withDO(w.DO.Distinct(cols...))
}

func (w winAdminExportFileTaskDo) Omit(cols ...field.Expr) *winAdminExportFileTaskDo {
	return w.withDO(w.DO.Omit(cols...))
}

func (w winAdminExportFileTaskDo) Join(table schema.Tabler, on ...field.Expr) *winAdminExportFileTaskDo {
	return w.withDO(w.DO.Join(table, on...))
}

func (w winAdminExportFileTaskDo) LeftJoin(table schema.Tabler, on ...field.Expr) *winAdminExportFileTaskDo {
	return w.withDO(w.DO.LeftJoin(table, on...))
}

func (w winAdminExportFileTaskDo) RightJoin(table schema.Tabler, on ...field.Expr) *winAdminExportFileTaskDo {
	return w.withDO(w.DO.RightJoin(table, on...))
}

func (w winAdminExportFileTaskDo) Group(cols ...field.Expr) *winAdminExportFileTaskDo {
	return w.withDO(w.DO.Group(cols...))
}

func (w winAdminExportFileTaskDo) Having(conds ...gen.Condition) *winAdminExportFileTaskDo {
	return w.withDO(w.DO.Having(conds...))
}

func (w winAdminExportFileTaskDo) Limit(limit int) *winAdminExportFileTaskDo {
	return w.withDO(w.DO.Limit(limit))
}

func (w winAdminExportFileTaskDo) Offset(offset int) *winAdminExportFileTaskDo {
	return w.withDO(w.DO.Offset(offset))
}

func (w winAdminExportFileTaskDo) Scopes(funcs ...func(gen.Dao) gen.Dao) *winAdminExportFileTaskDo {
	return w.withDO(w.DO.Scopes(funcs...))
}

func (w winAdminExportFileTaskDo) Unscoped() *winAdminExportFileTaskDo {
...
func (w winAdminExportFileTaskDo) Attrs(attrs ...field.AssignExpr) *winAdminExportFileTaskDo {
	return w.withDO(w.DO.Attrs(attrs...))
}

func (w winAdminExportFileTaskDo) Assign(attrs ...field.AssignExpr) *winAdminExportFileTaskDo {
	return w.withDO(w.DO.Assign(attrs...))
}

func (w winAdminExportFileTaskDo) Joins(fields ...field.RelationField) *winAdminExportFileTaskDo {
...
func (w winAdminExportFileTaskDo) Preload(fields ...field.RelationField) *winAdminExportFileTaskDo {
	for _, _f := range fields {
