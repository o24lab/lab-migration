...
func newWinOperationLog(db *gorm.DB, opts ...gen.DOOption) winOperationLog {
	...
	_winOperationLog.UID = field.NewInt32(tableName, "uid")
	...
	_winOperationLog.MenuIndex = field.NewInt32(tableName, "menu_index")
	...
	_winOperationLog.CreatedAt = field.NewInt32(tableName, "created_at")
	_winOperationLog.UpdatedAt = field.NewInt32(tableName, "updated_at")
...
func (w *winOperationLog) updateTableName(table string) *winOperationLog {
	...
	w.MenuIndex = field.NewInt32(table, "menu_index")
...
func (w winOperationLogDo) Debug() *winOperationLogDo {
	return w.withDO(w.DO.Debug())
}

func (w winOperationLogDo) WithContext(ctx context.Context) *winOperationLogDo {
	return w.withDO(w.DO.WithContext(ctx))
}

func (w winOperationLogDo) ReadDB() *winOperationLogDo {
	return w.Clauses(dbresolver.Read)
}

func (w winOperationLogDo) WriteDB() *winOperationLogDo {
	return w.Clauses(dbresolver.Write)
}

func (w winOperationLogDo) Session(config *gorm.Session) *winOperationLogDo {
	return w.withDO(w.DO.Session(config))
}

func (w winOperationLogDo) Clauses(conds ...clause.Expression) *winOperationLogDo {
	return w.withDO(w.DO.Clauses(conds...))
}

func (w winOperationLogDo) Returning(value interface{}, columns ...string) *winOperationLogDo {
	return w.withDO(w.DO.Returning(value, columns...))
}

func (w winOperationLogDo) Not(conds ...gen.Condition) *winOperationLogDo {
	return w.withDO(w.DO.Not(conds...))
}

func (w winOperationLogDo) Or(conds ...gen.Condition) *winOperationLogDo {
	return w.withDO(w.DO.Or(conds...))
}

func (w winOperationLogDo) Select(conds ...field.Expr) *winOperationLogDo {
	return w.withDO(w.DO.Select(conds...))
}

func (w winOperationLogDo) Where(conds ...gen.Condition) *winOperationLogDo {
	return w.withDO(w.DO.Where(conds...))
}

func (w winOperationLogDo) Order(conds ...field.Expr) *winOperationLogDo {
	return w.withDO(w.DO.Order(conds...))
}

func (w winOperationLogDo) Distinct(cols ...field.Expr) *winOperationLogDo {
	return w.withDO(w.DO.Distinct(cols...))
}

func (w winOperationLogDo) Omit(cols ...field.Expr) *winOperationLogDo {
	return w.withDO(w.DO.Omit(cols...))
}

func (w winOperationLogDo) Join(table schema.Tabler, on ...field.Expr) *winOperationLogDo {
	return w.withDO(w.DO.Join(table, on...))
}

func (w winOperationLogDo) LeftJoin(table schema.Tabler, on ...field.Expr) *winOperationLogDo {
	return w.withDO(w.DO.LeftJoin(table, on...))
}

func (w winOperationLogDo) RightJoin(table schema.Tabler, on ...field.Expr) *winOperationLogDo {
	return w.withDO(w.DO.RightJoin(table, on...))
}

func (w winOperationLogDo) Group(cols ...field.Expr) *winOperationLogDo {
	return w.withDO(w.DO.Group(cols...))
}

func (w winOperationLogDo) Having(conds ...gen.Condition) *winOperationLogDo {
	return w.withDO(w.DO.Having(conds...))
}

func (w winOperationLogDo) Limit(limit int) *winOperationLogDo {
	return w.withDO(w.DO.Limit(limit))
}

func (w winOperationLogDo) Offset(offset int) *winOperationLogDo {
	return w.withDO(w.DO.Offset(offset))
}

func (w winOperationLogDo) Scopes(funcs ...func(gen.Dao) gen.Dao) *winOperationLogDo {
	return w.withDO(w.DO.Scopes(funcs...))
}

func (w winOperationLogDo) Unscoped() *winOperationLogDo {
...
func (w winOperationLogDo) Attrs(attrs ...field.AssignExpr) *winOperationLogDo {
	return w.withDO(w.DO.Attrs(attrs...))
}

func (w winOperationLogDo) Assign(attrs ...field.AssignExpr) *winOperationLogDo {
	return w.withDO(w.DO.Assign(attrs...))
}

func (w winOperationLogDo) Joins(fields ...field.RelationField) *winOperationLogDo {
...
func (w winOperationLogDo) Preload(fields ...field.RelationField) *winOperationLogDo {
	for _, _f := range fields {
