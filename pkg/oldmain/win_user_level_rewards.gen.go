...
func newWinUserLevelReward(db *gorm.DB, opts ...gen.DOOption) winUserLevelReward {
	...
	_winUserLevelReward.UID = field.NewInt32(tableName, "uid")
	_winUserLevelReward.Username = field.NewString(tableName, "username")
	_winUserLevelReward.Coin = field.NewFloat64(tableName, "coin")
	_winUserLevelReward.CoinBefore = field.NewFloat64(tableName, "coin_before")
	_winUserLevelReward.Category = field.NewInt32(tableName, "category")
	_winUserLevelReward.ReceiveAt = field.NewInt32(tableName, "receive_at")
	_winUserLevelReward.UserLevelID = field.NewInt32(tableName, "user_level_id")
	_winUserLevelReward.FlowClaim = field.NewInt32(tableName, "flow_claim")
	_winUserLevelReward.Codes = field.NewFloat64(tableName, "codes")
	_winUserLevelReward.EndedAt = field.NewInt32(tableName, "ended_at")
	_winUserLevelReward.Status = field.NewInt32(tableName, "status")
	_winUserLevelReward.CreatedAt = field.NewInt32(tableName, "created_at")
	_winUserLevelReward.UpdatedAt = field.NewInt32(tableName, "updated_at")
...
type winUserLevelReward struct {
	...
	Coin        field.Float64 // 彩金金额
	CoinBefore  field.Float64 // 即时金额
	Category    field.Int32   // 福利类型:0-晋级彩金 1-生日礼金 2-周彩金3 -月彩金
	ReceiveAt   field.Int32   // 领取时间
	UserLevelID field.Int32   // 用户等级编号
	FlowClaim   field.Int32   // 流水倍数
	Codes       field.Float64 // 所需打码量
	EndedAt     field.Int32   // 领取结束时间
	Status      field.Int32   // 状态:0-待领取 1-已领取 2-已过期
...
func (w *winUserLevelReward) updateTableName(table string) *winUserLevelReward {
	...
	w.ReceiveAt = field.NewInt32(table, "receive_at")
	w.UserLevelID = field.NewInt32(table, "user_level_id")
...
func (w winUserLevelRewardDo) Debug() *winUserLevelRewardDo {
	return w.withDO(w.DO.Debug())
}

func (w winUserLevelRewardDo) WithContext(ctx context.Context) *winUserLevelRewardDo {
	return w.withDO(w.DO.WithContext(ctx))
}

func (w winUserLevelRewardDo) ReadDB() *winUserLevelRewardDo {
	return w.Clauses(dbresolver.Read)
}

func (w winUserLevelRewardDo) WriteDB() *winUserLevelRewardDo {
	return w.Clauses(dbresolver.Write)
}

func (w winUserLevelRewardDo) Session(config *gorm.Session) *winUserLevelRewardDo {
	return w.withDO(w.DO.Session(config))
}

func (w winUserLevelRewardDo) Clauses(conds ...clause.Expression) *winUserLevelRewardDo {
	return w.withDO(w.DO.Clauses(conds...))
}

func (w winUserLevelRewardDo) Returning(value interface{}, columns ...string) *winUserLevelRewardDo {
	return w.withDO(w.DO.Returning(value, columns...))
}

func (w winUserLevelRewardDo) Not(conds ...gen.Condition) *winUserLevelRewardDo {
	return w.withDO(w.DO.Not(conds...))
}

func (w winUserLevelRewardDo) Or(conds ...gen.Condition) *winUserLevelRewardDo {
	return w.withDO(w.DO.Or(conds...))
}

func (w winUserLevelRewardDo) Select(conds ...field.Expr) *winUserLevelRewardDo {
	return w.withDO(w.DO.Select(conds...))
}

func (w winUserLevelRewardDo) Where(conds ...gen.Condition) *winUserLevelRewardDo {
	return w.withDO(w.DO.Where(conds...))
}

func (w winUserLevelRewardDo) Order(conds ...field.Expr) *winUserLevelRewardDo {
	return w.withDO(w.DO.Order(conds...))
}

func (w winUserLevelRewardDo) Distinct(cols ...field.Expr) *winUserLevelRewardDo {
	return w.withDO(w.DO.Distinct(cols...))
}

func (w winUserLevelRewardDo) Omit(cols ...field.Expr) *winUserLevelRewardDo {
	return w.withDO(w.DO.Omit(cols...))
}

func (w winUserLevelRewardDo) Join(table schema.Tabler, on ...field.Expr) *winUserLevelRewardDo {
	return w.withDO(w.DO.Join(table, on...))
}

func (w winUserLevelRewardDo) LeftJoin(table schema.Tabler, on ...field.Expr) *winUserLevelRewardDo {
	return w.withDO(w.DO.LeftJoin(table, on...))
}

func (w winUserLevelRewardDo) RightJoin(table schema.Tabler, on ...field.Expr) *winUserLevelRewardDo {
	return w.withDO(w.DO.RightJoin(table, on...))
}

func (w winUserLevelRewardDo) Group(cols ...field.Expr) *winUserLevelRewardDo {
	return w.withDO(w.DO.Group(cols...))
}

func (w winUserLevelRewardDo) Having(conds ...gen.Condition) *winUserLevelRewardDo {
	return w.withDO(w.DO.Having(conds...))
}

func (w winUserLevelRewardDo) Limit(limit int) *winUserLevelRewardDo {
	return w.withDO(w.DO.Limit(limit))
}

func (w winUserLevelRewardDo) Offset(offset int) *winUserLevelRewardDo {
	return w.withDO(w.DO.Offset(offset))
}

func (w winUserLevelRewardDo) Scopes(funcs ...func(gen.Dao) gen.Dao) *winUserLevelRewardDo {
	return w.withDO(w.DO.Scopes(funcs...))
}

func (w winUserLevelRewardDo) Unscoped() *winUserLevelRewardDo {
...
func (w winUserLevelRewardDo) Attrs(attrs ...field.AssignExpr) *winUserLevelRewardDo {
	return w.withDO(w.DO.Attrs(attrs...))
}

func (w winUserLevelRewardDo) Assign(attrs ...field.AssignExpr) *winUserLevelRewardDo {
	return w.withDO(w.DO.Assign(attrs...))
}

func (w winUserLevelRewardDo) Joins(fields ...field.RelationField) *winUserLevelRewardDo {
...
func (w winUserLevelRewardDo) Preload(fields ...field.RelationField) *winUserLevelRewardDo {
	for _, _f := range fields {
