...
func newXxlJobInfo(db *gorm.DB, opts ...gen.DOOption) xxlJobInfo {
	...
	_xxlJobInfo.ID = field.NewInt32(tableName, "id")
	_xxlJobInfo.JobGroup = field.NewInt32(tableName, "job_group")
	...
	_xxlJobInfo.ExecutorTimeout = field.NewInt32(tableName, "executor_timeout")
	_xxlJobInfo.ExecutorFailRetryCount = field.NewInt32(tableName, "executor_fail_retry_count")
	...
	_xxlJobInfo.TriggerStatus = field.NewInt32(tableName, "trigger_status")
...
type xxlJobInfo struct {
	...
	ExecutorTimeout        field.Int32  // 任务执行超时时间，单位秒
	...
	TriggerStatus          field.Int32  // 调度状态：0-停止，1-运行
...
func (x *xxlJobInfo) updateTableName(table string) *xxlJobInfo {
	...
	x.ExecutorTimeout = field.NewInt32(table, "executor_timeout")
	...
	x.TriggerStatus = field.NewInt32(table, "trigger_status")
...
func (x xxlJobInfoDo) Debug() *xxlJobInfoDo {
	return x.withDO(x.DO.Debug())
}

func (x xxlJobInfoDo) WithContext(ctx context.Context) *xxlJobInfoDo {
	return x.withDO(x.DO.WithContext(ctx))
}

func (x xxlJobInfoDo) ReadDB() *xxlJobInfoDo {
	return x.Clauses(dbresolver.Read)
}

func (x xxlJobInfoDo) WriteDB() *xxlJobInfoDo {
	return x.Clauses(dbresolver.Write)
}

func (x xxlJobInfoDo) Session(config *gorm.Session) *xxlJobInfoDo {
	return x.withDO(x.DO.Session(config))
}

func (x xxlJobInfoDo) Clauses(conds ...clause.Expression) *xxlJobInfoDo {
	return x.withDO(x.DO.Clauses(conds...))
}

func (x xxlJobInfoDo) Returning(value interface{}, columns ...string) *xxlJobInfoDo {
	return x.withDO(x.DO.Returning(value, columns...))
}

func (x xxlJobInfoDo) Not(conds ...gen.Condition) *xxlJobInfoDo {
	return x.withDO(x.DO.Not(conds...))
}

func (x xxlJobInfoDo) Or(conds ...gen.Condition) *xxlJobInfoDo {
	return x.withDO(x.DO.Or(conds...))
}

func (x xxlJobInfoDo) Select(conds ...field.Expr) *xxlJobInfoDo {
	return x.withDO(x.DO.Select(conds...))
}

func (x xxlJobInfoDo) Where(conds ...gen.Condition) *xxlJobInfoDo {
	return x.withDO(x.DO.Where(conds...))
}

func (x xxlJobInfoDo) Order(conds ...field.Expr) *xxlJobInfoDo {
	return x.withDO(x.DO.Order(conds...))
}

func (x xxlJobInfoDo) Distinct(cols ...field.Expr) *xxlJobInfoDo {
	return x.withDO(x.DO.Distinct(cols...))
}

func (x xxlJobInfoDo) Omit(cols ...field.Expr) *xxlJobInfoDo {
	return x.withDO(x.DO.Omit(cols...))
}

func (x xxlJobInfoDo) Join(table schema.Tabler, on ...field.Expr) *xxlJobInfoDo {
	return x.withDO(x.DO.Join(table, on...))
}

func (x xxlJobInfoDo) LeftJoin(table schema.Tabler, on ...field.Expr) *xxlJobInfoDo {
	return x.withDO(x.DO.LeftJoin(table, on...))
}

func (x xxlJobInfoDo) RightJoin(table schema.Tabler, on ...field.Expr) *xxlJobInfoDo {
	return x.withDO(x.DO.RightJoin(table, on...))
}

func (x xxlJobInfoDo) Group(cols ...field.Expr) *xxlJobInfoDo {
	return x.withDO(x.DO.Group(cols...))
}

func (x xxlJobInfoDo) Having(conds ...gen.Condition) *xxlJobInfoDo {
	return x.withDO(x.DO.Having(conds...))
}

func (x xxlJobInfoDo) Limit(limit int) *xxlJobInfoDo {
	return x.withDO(x.DO.Limit(limit))
}

func (x xxlJobInfoDo) Offset(offset int) *xxlJobInfoDo {
	return x.withDO(x.DO.Offset(offset))
}

func (x xxlJobInfoDo) Scopes(funcs ...func(gen.Dao) gen.Dao) *xxlJobInfoDo {
	return x.withDO(x.DO.Scopes(funcs...))
}

func (x xxlJobInfoDo) Unscoped() *xxlJobInfoDo {
...
func (x xxlJobInfoDo) Attrs(attrs ...field.AssignExpr) *xxlJobInfoDo {
	return x.withDO(x.DO.Attrs(attrs...))
}

func (x xxlJobInfoDo) Assign(attrs ...field.AssignExpr) *xxlJobInfoDo {
	return x.withDO(x.DO.Assign(attrs...))
}

func (x xxlJobInfoDo) Joins(fields ...field.RelationField) *xxlJobInfoDo {
...
func (x xxlJobInfoDo) Preload(fields ...field.RelationField) *xxlJobInfoDo {
	for _, _f := range fields {
