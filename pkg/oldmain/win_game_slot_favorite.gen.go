...
func newWinGameSlotFavorite(db *gorm.DB, opts ...gen.DOOption) winGameSlotFavorite {
	...
	_winGameSlotFavorite.ID = field.NewInt32(tableName, "id")
	_winGameSlotFavorite.UID = field.NewInt32(tableName, "uid")
	_winGameSlotFavorite.GameID = field.NewInt32(tableName, "game_id")
	_winGameSlotFavorite.GameSlotID = field.NewString(tableName, "game_slot_id")
	_winGameSlotFavorite.CreatedAt = field.NewInt32(tableName, "created_at")
	_winGameSlotFavorite.UpdatedAt = field.NewInt32(tableName, "updated_at")
...
func (w winGameSlotFavoriteDo) Debug() *winGameSlotFavoriteDo {
	return w.withDO(w.DO.Debug())
}

func (w winGameSlotFavoriteDo) WithContext(ctx context.Context) *winGameSlotFavoriteDo {
	return w.withDO(w.DO.WithContext(ctx))
}

func (w winGameSlotFavoriteDo) ReadDB() *winGameSlotFavoriteDo {
	return w.Clauses(dbresolver.Read)
}

func (w winGameSlotFavoriteDo) WriteDB() *winGameSlotFavoriteDo {
	return w.Clauses(dbresolver.Write)
}

func (w winGameSlotFavoriteDo) Session(config *gorm.Session) *winGameSlotFavoriteDo {
	return w.withDO(w.DO.Session(config))
}

func (w winGameSlotFavoriteDo) Clauses(conds ...clause.Expression) *winGameSlotFavoriteDo {
	return w.withDO(w.DO.Clauses(conds...))
}

func (w winGameSlotFavoriteDo) Returning(value interface{}, columns ...string) *winGameSlotFavoriteDo {
	return w.withDO(w.DO.Returning(value, columns...))
}

func (w winGameSlotFavoriteDo) Not(conds ...gen.Condition) *winGameSlotFavoriteDo {
	return w.withDO(w.DO.Not(conds...))
}

func (w winGameSlotFavoriteDo) Or(conds ...gen.Condition) *winGameSlotFavoriteDo {
	return w.withDO(w.DO.Or(conds...))
}

func (w winGameSlotFavoriteDo) Select(conds ...field.Expr) *winGameSlotFavoriteDo {
	return w.withDO(w.DO.Select(conds...))
}

func (w winGameSlotFavoriteDo) Where(conds ...gen.Condition) *winGameSlotFavoriteDo {
	return w.withDO(w.DO.Where(conds...))
}

func (w winGameSlotFavoriteDo) Order(conds ...field.Expr) *winGameSlotFavoriteDo {
	return w.withDO(w.DO.Order(conds...))
}

func (w winGameSlotFavoriteDo) Distinct(cols ...field.Expr) *winGameSlotFavoriteDo {
	return w.withDO(w.DO.Distinct(cols...))
}

func (w winGameSlotFavoriteDo) Omit(cols ...field.Expr) *winGameSlotFavoriteDo {
	return w.withDO(w.DO.Omit(cols...))
}

func (w winGameSlotFavoriteDo) Join(table schema.Tabler, on ...field.Expr) *winGameSlotFavoriteDo {
	return w.withDO(w.DO.Join(table, on...))
}

func (w winGameSlotFavoriteDo) LeftJoin(table schema.Tabler, on ...field.Expr) *winGameSlotFavoriteDo {
	return w.withDO(w.DO.LeftJoin(table, on...))
}

func (w winGameSlotFavoriteDo) RightJoin(table schema.Tabler, on ...field.Expr) *winGameSlotFavoriteDo {
	return w.withDO(w.DO.RightJoin(table, on...))
}

func (w winGameSlotFavoriteDo) Group(cols ...field.Expr) *winGameSlotFavoriteDo {
	return w.withDO(w.DO.Group(cols...))
}

func (w winGameSlotFavoriteDo) Having(conds ...gen.Condition) *winGameSlotFavoriteDo {
	return w.withDO(w.DO.Having(conds...))
}

func (w winGameSlotFavoriteDo) Limit(limit int) *winGameSlotFavoriteDo {
	return w.withDO(w.DO.Limit(limit))
}

func (w winGameSlotFavoriteDo) Offset(offset int) *winGameSlotFavoriteDo {
	return w.withDO(w.DO.Offset(offset))
}

func (w winGameSlotFavoriteDo) Scopes(funcs ...func(gen.Dao) gen.Dao) *winGameSlotFavoriteDo {
	return w.withDO(w.DO.Scopes(funcs...))
}

func (w winGameSlotFavoriteDo) Unscoped() *winGameSlotFavoriteDo {
...
func (w winGameSlotFavoriteDo) Attrs(attrs ...field.AssignExpr) *winGameSlotFavoriteDo {
	return w.withDO(w.DO.Attrs(attrs...))
}

func (w winGameSlotFavoriteDo) Assign(attrs ...field.AssignExpr) *winGameSlotFavoriteDo {
	return w.withDO(w.DO.Assign(attrs...))
}

func (w winGameSlotFavoriteDo) Joins(fields ...field.RelationField) *winGameSlotFavoriteDo {
...
func (w winGameSlotFavoriteDo) Preload(fields ...field.RelationField) *winGameSlotFavoriteDo {
	for _, _f := range fields {
