...
func newWinUserGoogleLogin(db *gorm.DB, opts ...gen.DOOption) winUserGoogleLogin {
	...
	_winUserGoogleLogin.ID = field.NewInt32(tableName, "id")
	_winUserGoogleLogin.UserID = field.NewInt32(tableName, "user_id")
	...
	_winUserGoogleLogin.CreatedAt = field.NewInt32(tableName, "created_at")
...
func (w winUserGoogleLoginDo) Debug() *winUserGoogleLoginDo {
	return w.withDO(w.DO.Debug())
}

func (w winUserGoogleLoginDo) WithContext(ctx context.Context) *winUserGoogleLoginDo {
	return w.withDO(w.DO.WithContext(ctx))
}

func (w winUserGoogleLoginDo) ReadDB() *winUserGoogleLoginDo {
	return w.Clauses(dbresolver.Read)
}

func (w winUserGoogleLoginDo) WriteDB() *winUserGoogleLoginDo {
	return w.Clauses(dbresolver.Write)
}

func (w winUserGoogleLoginDo) Session(config *gorm.Session) *winUserGoogleLoginDo {
	return w.withDO(w.DO.Session(config))
}

func (w winUserGoogleLoginDo) Clauses(conds ...clause.Expression) *winUserGoogleLoginDo {
	return w.withDO(w.DO.Clauses(conds...))
}

func (w winUserGoogleLoginDo) Returning(value interface{}, columns ...string) *winUserGoogleLoginDo {
	return w.withDO(w.DO.Returning(value, columns...))
}

func (w winUserGoogleLoginDo) Not(conds ...gen.Condition) *winUserGoogleLoginDo {
	return w.withDO(w.DO.Not(conds...))
}

func (w winUserGoogleLoginDo) Or(conds ...gen.Condition) *winUserGoogleLoginDo {
	return w.withDO(w.DO.Or(conds...))
}

func (w winUserGoogleLoginDo) Select(conds ...field.Expr) *winUserGoogleLoginDo {
	return w.withDO(w.DO.Select(conds...))
}

func (w winUserGoogleLoginDo) Where(conds ...gen.Condition) *winUserGoogleLoginDo {
	return w.withDO(w.DO.Where(conds...))
}

func (w winUserGoogleLoginDo) Order(conds ...field.Expr) *winUserGoogleLoginDo {
	return w.withDO(w.DO.Order(conds...))
}

func (w winUserGoogleLoginDo) Distinct(cols ...field.Expr) *winUserGoogleLoginDo {
	return w.withDO(w.DO.Distinct(cols...))
}

func (w winUserGoogleLoginDo) Omit(cols ...field.Expr) *winUserGoogleLoginDo {
	return w.withDO(w.DO.Omit(cols...))
}

func (w winUserGoogleLoginDo) Join(table schema.Tabler, on ...field.Expr) *winUserGoogleLoginDo {
	return w.withDO(w.DO.Join(table, on...))
}

func (w winUserGoogleLoginDo) LeftJoin(table schema.Tabler, on ...field.Expr) *winUserGoogleLoginDo {
	return w.withDO(w.DO.LeftJoin(table, on...))
}

func (w winUserGoogleLoginDo) RightJoin(table schema.Tabler, on ...field.Expr) *winUserGoogleLoginDo {
	return w.withDO(w.DO.RightJoin(table, on...))
}

func (w winUserGoogleLoginDo) Group(cols ...field.Expr) *winUserGoogleLoginDo {
	return w.withDO(w.DO.Group(cols...))
}

func (w winUserGoogleLoginDo) Having(conds ...gen.Condition) *winUserGoogleLoginDo {
	return w.withDO(w.DO.Having(conds...))
}

func (w winUserGoogleLoginDo) Limit(limit int) *winUserGoogleLoginDo {
	return w.withDO(w.DO.Limit(limit))
}

func (w winUserGoogleLoginDo) Offset(offset int) *winUserGoogleLoginDo {
	return w.withDO(w.DO.Offset(offset))
}

func (w winUserGoogleLoginDo) Scopes(funcs ...func(gen.Dao) gen.Dao) *winUserGoogleLoginDo {
	return w.withDO(w.DO.Scopes(funcs...))
}

func (w winUserGoogleLoginDo) Unscoped() *winUserGoogleLoginDo {
...
func (w winUserGoogleLoginDo) Attrs(attrs ...field.AssignExpr) *winUserGoogleLoginDo {
	return w.withDO(w.DO.Attrs(attrs...))
}

func (w winUserGoogleLoginDo) Assign(attrs ...field.AssignExpr) *winUserGoogleLoginDo {
	return w.withDO(w.DO.Assign(attrs...))
}

func (w winUserGoogleLoginDo) Joins(fields ...field.RelationField) *winUserGoogleLoginDo {
...
func (w winUserGoogleLoginDo) Preload(fields ...field.RelationField) *winUserGoogleLoginDo {
	for _, _f := range fields {
