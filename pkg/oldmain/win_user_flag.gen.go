...
func newWinUserFlag(db *gorm.DB, opts ...gen.DOOption) winUserFlag {
	...
	_winUserFlag.ID = field.NewInt32(tableName, "id")
	_winUserFlag.BitCode = field.NewInt32(tableName, "bit_code")
	...
	_winUserFlag.Status = field.NewInt32(tableName, "status")
	_winUserFlag.CreatedAt = field.NewInt32(tableName, "created_at")
	_winUserFlag.UpdatedAt = field.NewInt32(tableName, "updated_at")
...
func (w *winUserFlag) updateTableName(table string) *winUserFlag {
	...
	w.BitCode = field.NewInt32(table, "bit_code")
...
func (w winUserFlagDo) Debug() *winUserFlagDo {
	return w.withDO(w.DO.Debug())
}

func (w winUserFlagDo) WithContext(ctx context.Context) *winUserFlagDo {
	return w.withDO(w.DO.WithContext(ctx))
}

func (w winUserFlagDo) ReadDB() *winUserFlagDo {
	return w.Clauses(dbresolver.Read)
}

func (w winUserFlagDo) WriteDB() *winUserFlagDo {
	return w.Clauses(dbresolver.Write)
}

func (w winUserFlagDo) Session(config *gorm.Session) *winUserFlagDo {
	return w.withDO(w.DO.Session(config))
}

func (w winUserFlagDo) Clauses(conds ...clause.Expression) *winUserFlagDo {
	return w.withDO(w.DO.Clauses(conds...))
}

func (w winUserFlagDo) Returning(value interface{}, columns ...string) *winUserFlagDo {
	return w.withDO(w.DO.Returning(value, columns...))
}

func (w winUserFlagDo) Not(conds ...gen.Condition) *winUserFlagDo {
	return w.withDO(w.DO.Not(conds...))
}

func (w winUserFlagDo) Or(conds ...gen.Condition) *winUserFlagDo {
	return w.withDO(w.DO.Or(conds...))
}

func (w winUserFlagDo) Select(conds ...field.Expr) *winUserFlagDo {
	return w.withDO(w.DO.Select(conds...))
}

func (w winUserFlagDo) Where(conds ...gen.Condition) *winUserFlagDo {
	return w.withDO(w.DO.Where(conds...))
}

func (w winUserFlagDo) Order(conds ...field.Expr) *winUserFlagDo {
	return w.withDO(w.DO.Order(conds...))
}

func (w winUserFlagDo) Distinct(cols ...field.Expr) *winUserFlagDo {
	return w.withDO(w.DO.Distinct(cols...))
}

func (w winUserFlagDo) Omit(cols ...field.Expr) *winUserFlagDo {
	return w.withDO(w.DO.Omit(cols...))
}

func (w winUserFlagDo) Join(table schema.Tabler, on ...field.Expr) *winUserFlagDo {
	return w.withDO(w.DO.Join(table, on...))
}

func (w winUserFlagDo) LeftJoin(table schema.Tabler, on ...field.Expr) *winUserFlagDo {
	return w.withDO(w.DO.LeftJoin(table, on...))
}

func (w winUserFlagDo) RightJoin(table schema.Tabler, on ...field.Expr) *winUserFlagDo {
	return w.withDO(w.DO.RightJoin(table, on...))
}

func (w winUserFlagDo) Group(cols ...field.Expr) *winUserFlagDo {
	return w.withDO(w.DO.Group(cols...))
}

func (w winUserFlagDo) Having(conds ...gen.Condition) *winUserFlagDo {
	return w.withDO(w.DO.Having(conds...))
}

func (w winUserFlagDo) Limit(limit int) *winUserFlagDo {
	return w.withDO(w.DO.Limit(limit))
}

func (w winUserFlagDo) Offset(offset int) *winUserFlagDo {
	return w.withDO(w.DO.Offset(offset))
}

func (w winUserFlagDo) Scopes(funcs ...func(gen.Dao) gen.Dao) *winUserFlagDo {
	return w.withDO(w.DO.Scopes(funcs...))
}

func (w winUserFlagDo) Unscoped() *winUserFlagDo {
...
func (w winUserFlagDo) Attrs(attrs ...field.AssignExpr) *winUserFlagDo {
	return w.withDO(w.DO.Attrs(attrs...))
}

func (w winUserFlagDo) Assign(attrs ...field.AssignExpr) *winUserFlagDo {
	return w.withDO(w.DO.Assign(attrs...))
}

func (w winUserFlagDo) Joins(fields ...field.RelationField) *winUserFlagDo {
...
func (w winUserFlagDo) Preload(fields ...field.RelationField) *winUserFlagDo {
	for _, _f := range fields {
