...
func newWinSmsRecord(db *gorm.DB, opts ...gen.DOOption) winSmsRecord {
	...
	_winSmsRecord.Status = field.NewInt32(tableName, "status")
	_winSmsRecord.SendSmsType = field.NewString(tableName, "send_sms_type")
	_winSmsRecord.CreatedAt = field.NewInt32(tableName, "created_at")
	_winSmsRecord.UpdatedAt = field.NewInt32(tableName, "updated_at")
...
type winSmsRecord struct {
	...
	Status      field.Int32  // 状态:0-未使用 1-已使用
...
func (w winSmsRecordDo) Debug() *winSmsRecordDo {
	return w.withDO(w.DO.Debug())
}

func (w winSmsRecordDo) WithContext(ctx context.Context) *winSmsRecordDo {
	return w.withDO(w.DO.WithContext(ctx))
}

func (w winSmsRecordDo) ReadDB() *winSmsRecordDo {
	return w.Clauses(dbresolver.Read)
}

func (w winSmsRecordDo) WriteDB() *winSmsRecordDo {
	return w.Clauses(dbresolver.Write)
}

func (w winSmsRecordDo) Session(config *gorm.Session) *winSmsRecordDo {
	return w.withDO(w.DO.Session(config))
}

func (w winSmsRecordDo) Clauses(conds ...clause.Expression) *winSmsRecordDo {
	return w.withDO(w.DO.Clauses(conds...))
}

func (w winSmsRecordDo) Returning(value interface{}, columns ...string) *winSmsRecordDo {
	return w.withDO(w.DO.Returning(value, columns...))
}

func (w winSmsRecordDo) Not(conds ...gen.Condition) *winSmsRecordDo {
	return w.withDO(w.DO.Not(conds...))
}

func (w winSmsRecordDo) Or(conds ...gen.Condition) *winSmsRecordDo {
	return w.withDO(w.DO.Or(conds...))
}

func (w winSmsRecordDo) Select(conds ...field.Expr) *winSmsRecordDo {
	return w.withDO(w.DO.Select(conds...))
}

func (w winSmsRecordDo) Where(conds ...gen.Condition) *winSmsRecordDo {
	return w.withDO(w.DO.Where(conds...))
}

func (w winSmsRecordDo) Order(conds ...field.Expr) *winSmsRecordDo {
	return w.withDO(w.DO.Order(conds...))
}

func (w winSmsRecordDo) Distinct(cols ...field.Expr) *winSmsRecordDo {
	return w.withDO(w.DO.Distinct(cols...))
}

func (w winSmsRecordDo) Omit(cols ...field.Expr) *winSmsRecordDo {
	return w.withDO(w.DO.Omit(cols...))
}

func (w winSmsRecordDo) Join(table schema.Tabler, on ...field.Expr) *winSmsRecordDo {
	return w.withDO(w.DO.Join(table, on...))
}

func (w winSmsRecordDo) LeftJoin(table schema.Tabler, on ...field.Expr) *winSmsRecordDo {
	return w.withDO(w.DO.LeftJoin(table, on...))
}

func (w winSmsRecordDo) RightJoin(table schema.Tabler, on ...field.Expr) *winSmsRecordDo {
	return w.withDO(w.DO.RightJoin(table, on...))
}

func (w winSmsRecordDo) Group(cols ...field.Expr) *winSmsRecordDo {
	return w.withDO(w.DO.Group(cols...))
}

func (w winSmsRecordDo) Having(conds ...gen.Condition) *winSmsRecordDo {
	return w.withDO(w.DO.Having(conds...))
}

func (w winSmsRecordDo) Limit(limit int) *winSmsRecordDo {
	return w.withDO(w.DO.Limit(limit))
}

func (w winSmsRecordDo) Offset(offset int) *winSmsRecordDo {
	return w.withDO(w.DO.Offset(offset))
}

func (w winSmsRecordDo) Scopes(funcs ...func(gen.Dao) gen.Dao) *winSmsRecordDo {
	return w.withDO(w.DO.Scopes(funcs...))
}

func (w winSmsRecordDo) Unscoped() *winSmsRecordDo {
...
func (w winSmsRecordDo) Attrs(attrs ...field.AssignExpr) *winSmsRecordDo {
	return w.withDO(w.DO.Attrs(attrs...))
}

func (w winSmsRecordDo) Assign(attrs ...field.AssignExpr) *winSmsRecordDo {
	return w.withDO(w.DO.Assign(attrs...))
}

func (w winSmsRecordDo) Joins(fields ...field.RelationField) *winSmsRecordDo {
...
func (w winSmsRecordDo) Preload(fields ...field.RelationField) *winSmsRecordDo {
	for _, _f := range fields {
