...
func newWinUser(db *gorm.DB, opts ...gen.DOOption) winUser {
	...
	_winUser.ID = field.NewInt32(tableName, "id")
	_winUser.Username = field.NewString(tableName, "username")
	_winUser.MerchantID = field.NewInt32(tableName, "merchant_id")
	_winUser.Avatar = field.NewString(tableName, "avatar")
	_winUser.Fcoin = field.NewFloat64(tableName, "fcoin")
	_winUser.CoinCommission = field.NewFloat64(tableName, "coin_commission")
	_winUser.LevelID = field.NewInt32(tableName, "level_id")
	_winUser.Role = field.NewInt32(tableName, "role")
	_winUser.IsPromoter = field.NewInt32(tableName, "is_promoter")
	_winUser.Flag = field.NewInt32(tableName, "flag")
	...
	_winUser.Sex = field.NewInt32(tableName, "sex")
	_winUser.BindBank = field.NewInt32(tableName, "bind_bank")
	_winUser.Address = field.NewString(tableName, "address")
	_winUser.Score = field.NewInt32(tableName, "score")
	_winUser.PromoCode = field.NewString(tableName, "promo_code")
	_winUser.SupUid1 = field.NewInt32(tableName, "sup_uid_1")
	_winUser.SupUsername1 = field.NewString(tableName, "sup_username_1")
	_winUser.SupUid2 = field.NewInt32(tableName, "sup_uid_2")
	_winUser.SupUid3 = field.NewInt32(tableName, "sup_uid_3")
	_winUser.SupUid4 = field.NewInt32(tableName, "sup_uid_4")
	_winUser.SupUid5 = field.NewInt32(tableName, "sup_uid_5")
	_winUser.SupUid6 = field.NewInt32(tableName, "sup_uid_6")
	_winUser.SupUIDTop = field.NewInt32(tableName, "sup_uid_top")
	_winUser.SupUsernameTop = field.NewString(tableName, "sup_username_top")
	_winUser.SupLevelTop = field.NewInt32(tableName, "sup_level_top")
	...
	_winUser.Status = field.NewInt32(tableName, "status")
	...
	_winUser.LastLoginTime = field.NewInt32(tableName, "last_login_time")
	_winUser.LastLoginDeviceID = field.NewString(tableName, "last_login_device_id")
	_winUser.CreatedAt = field.NewInt32(tableName, "created_at")
	_winUser.UpdatedAt = field.NewInt32(tableName, "updated_at")
	_winUser.FreezeCause = field.NewString(tableName, "freeze_cause")
	_winUser.FreezeAt = field.NewInt32(tableName, "freeze_at")
	_winUser.OperatorName = field.NewString(tableName, "operator_name")
	_winUser.HaveDeposit = field.NewInt32(tableName, "have_deposit")
	_winUser.HaveBonus = field.NewInt32(tableName, "have_bonus")
...
type winUser struct {
	...
	Fcoin             field.Float64 // 冻结金额
	CoinCommission    field.Float64 // 佣金可提现金额
	LevelID           field.Int32   // 会员等级
	Role              field.Int32   // 角色:0-会员 1-代理 4-测试
	IsPromoter        field.Int32   // 是否推广:0-不是 1-是
	Flag              field.Int32   // 会员旗
	...
	Sex               field.Int32   // 性别:1-男 0-女 2-未知
	BindBank          field.Int32   // 是否绑定银行卡:1-已绑定 0-未绑定
	...
	SupUid4           field.Int32   // 上4级代理
	SupUid5           field.Int32   // 上5级代理
	SupUid6           field.Int32   // 上6级代理
	SupUIDTop         field.Int32   // 顶级推广用户名
	SupUsernameTop    field.String  // 顶级推广用户名
	SupLevelTop       field.Int32   // 顶级推广层级
...
func (w *winUser) updateTableName(table string) *winUser {
	...
	w.Fcoin = field.NewFloat64(table, "fcoin")
	w.CoinCommission = field.NewFloat64(table, "coin_commission")
	w.LevelID = field.NewInt32(table, "level_id")
	w.Role = field.NewInt32(table, "role")
	w.IsPromoter = field.NewInt32(table, "is_promoter")
	...
	w.BindBank = field.NewInt32(table, "bind_bank")
	w.Address = field.NewString(table, "address")
	w.Score = field.NewInt32(table, "score")
	w.PromoCode = field.NewString(table, "promo_code")
	w.SupUid1 = field.NewInt32(table, "sup_uid_1")
	w.SupUsername1 = field.NewString(table, "sup_username_1")
	w.SupUid2 = field.NewInt32(table, "sup_uid_2")
	w.SupUid3 = field.NewInt32(table, "sup_uid_3")
	w.SupUid4 = field.NewInt32(table, "sup_uid_4")
	w.SupUid5 = field.NewInt32(table, "sup_uid_5")
	w.SupUid6 = field.NewInt32(table, "sup_uid_6")
	w.SupUIDTop = field.NewInt32(table, "sup_uid_top")
	w.SupUsernameTop = field.NewString(table, "sup_username_top")
	w.SupLevelTop = field.NewInt32(table, "sup_level_top")
	...
	w.LastLoginTime = field.NewInt32(table, "last_login_time")
	...
	w.FreezeAt = field.NewInt32(table, "freeze_at")
	w.OperatorName = field.NewString(table, "operator_name")
	w.HaveDeposit = field.NewInt32(table, "have_deposit")
	w.HaveBonus = field.NewInt32(table, "have_bonus")
...
func (w *winUser) fillFieldMap() {
	w.fieldMap = make(map[string]field.Expr, 48)
	w.fieldMap["id"] = w.ID
	...
	w.fieldMap["have_deposit"] = w.HaveDeposit
	w.fieldMap["have_bonus"] = w.HaveBonus
}
...
func (w winUserDo) Debug() *winUserDo {
	return w.withDO(w.DO.Debug())
}

func (w winUserDo) WithContext(ctx context.Context) *winUserDo {
	return w.withDO(w.DO.WithContext(ctx))
}

func (w winUserDo) ReadDB() *winUserDo {
	return w.Clauses(dbresolver.Read)
}

func (w winUserDo) WriteDB() *winUserDo {
	return w.Clauses(dbresolver.Write)
}

func (w winUserDo) Session(config *gorm.Session) *winUserDo {
	return w.withDO(w.DO.Session(config))
}

func (w winUserDo) Clauses(conds ...clause.Expression) *winUserDo {
	return w.withDO(w.DO.Clauses(conds...))
}

func (w winUserDo) Returning(value interface{}, columns ...string) *winUserDo {
	return w.withDO(w.DO.Returning(value, columns...))
}

func (w winUserDo) Not(conds ...gen.Condition) *winUserDo {
	return w.withDO(w.DO.Not(conds...))
}

func (w winUserDo) Or(conds ...gen.Condition) *winUserDo {
	return w.withDO(w.DO.Or(conds...))
}

func (w winUserDo) Select(conds ...field.Expr) *winUserDo {
	return w.withDO(w.DO.Select(conds...))
}

func (w winUserDo) Where(conds ...gen.Condition) *winUserDo {
	return w.withDO(w.DO.Where(conds...))
}

func (w winUserDo) Order(conds ...field.Expr) *winUserDo {
	return w.withDO(w.DO.Order(conds...))
}

func (w winUserDo) Distinct(cols ...field.Expr) *winUserDo {
	return w.withDO(w.DO.Distinct(cols...))
}

func (w winUserDo) Omit(cols ...field.Expr) *winUserDo {
	return w.withDO(w.DO.Omit(cols...))
}

func (w winUserDo) Join(table schema.Tabler, on ...field.Expr) *winUserDo {
	return w.withDO(w.DO.Join(table, on...))
}

func (w winUserDo) LeftJoin(table schema.Tabler, on ...field.Expr) *winUserDo {
	return w.withDO(w.DO.LeftJoin(table, on...))
}

func (w winUserDo) RightJoin(table schema.Tabler, on ...field.Expr) *winUserDo {
	return w.withDO(w.DO.RightJoin(table, on...))
}

func (w winUserDo) Group(cols ...field.Expr) *winUserDo {
	return w.withDO(w.DO.Group(cols...))
}

func (w winUserDo) Having(conds ...gen.Condition) *winUserDo {
	return w.withDO(w.DO.Having(conds...))
}

func (w winUserDo) Limit(limit int) *winUserDo {
	return w.withDO(w.DO.Limit(limit))
}

func (w winUserDo) Offset(offset int) *winUserDo {
	return w.withDO(w.DO.Offset(offset))
}

func (w winUserDo) Scopes(funcs ...func(gen.Dao) gen.Dao) *winUserDo {
	return w.withDO(w.DO.Scopes(funcs...))
}

func (w winUserDo) Unscoped() *winUserDo {
...
func (w winUserDo) Attrs(attrs ...field.AssignExpr) *winUserDo {
	return w.withDO(w.DO.Attrs(attrs...))
}

func (w winUserDo) Assign(attrs ...field.AssignExpr) *winUserDo {
	return w.withDO(w.DO.Assign(attrs...))
}

func (w winUserDo) Joins(fields ...field.RelationField) *winUserDo {
...
func (w winUserDo) Preload(fields ...field.RelationField) *winUserDo {
	for _, _f := range fields {
