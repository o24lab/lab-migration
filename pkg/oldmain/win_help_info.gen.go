...
func newWinHelpInfo(db *gorm.DB, opts ...gen.DOOption) winHelpInfo {
	...
	_winHelpInfo.ID = field.NewInt32(tableName, "id")
	_winHelpInfo.HelpTypeID = field.NewInt32(tableName, "help_type_id")
	_winHelpInfo.Language = field.NewString(tableName, "language")
	_winHelpInfo.Title = field.NewString(tableName, "title")
	_winHelpInfo.Sort = field.NewInt32(tableName, "sort")
	_winHelpInfo.Status = field.NewInt32(tableName, "status")
	...
	_winHelpInfo.CreatedAt = field.NewInt32(tableName, "created_at")
	_winHelpInfo.UpdatedAt = field.NewInt32(tableName, "updated_at")
...
func (w *winHelpInfo) updateTableName(table string) *winHelpInfo {
	...
	w.HelpTypeID = field.NewInt32(table, "help_type_id")
...
func (w winHelpInfoDo) Debug() *winHelpInfoDo {
	return w.withDO(w.DO.Debug())
}

func (w winHelpInfoDo) WithContext(ctx context.Context) *winHelpInfoDo {
	return w.withDO(w.DO.WithContext(ctx))
}

func (w winHelpInfoDo) ReadDB() *winHelpInfoDo {
	return w.Clauses(dbresolver.Read)
}

func (w winHelpInfoDo) WriteDB() *winHelpInfoDo {
	return w.Clauses(dbresolver.Write)
}

func (w winHelpInfoDo) Session(config *gorm.Session) *winHelpInfoDo {
	return w.withDO(w.DO.Session(config))
}

func (w winHelpInfoDo) Clauses(conds ...clause.Expression) *winHelpInfoDo {
	return w.withDO(w.DO.Clauses(conds...))
}

func (w winHelpInfoDo) Returning(value interface{}, columns ...string) *winHelpInfoDo {
	return w.withDO(w.DO.Returning(value, columns...))
}

func (w winHelpInfoDo) Not(conds ...gen.Condition) *winHelpInfoDo {
	return w.withDO(w.DO.Not(conds...))
}

func (w winHelpInfoDo) Or(conds ...gen.Condition) *winHelpInfoDo {
	return w.withDO(w.DO.Or(conds...))
}

func (w winHelpInfoDo) Select(conds ...field.Expr) *winHelpInfoDo {
	return w.withDO(w.DO.Select(conds...))
}

func (w winHelpInfoDo) Where(conds ...gen.Condition) *winHelpInfoDo {
	return w.withDO(w.DO.Where(conds...))
}

func (w winHelpInfoDo) Order(conds ...field.Expr) *winHelpInfoDo {
	return w.withDO(w.DO.Order(conds...))
}

func (w winHelpInfoDo) Distinct(cols ...field.Expr) *winHelpInfoDo {
	return w.withDO(w.DO.Distinct(cols...))
}

func (w winHelpInfoDo) Omit(cols ...field.Expr) *winHelpInfoDo {
	return w.withDO(w.DO.Omit(cols...))
}

func (w winHelpInfoDo) Join(table schema.Tabler, on ...field.Expr) *winHelpInfoDo {
	return w.withDO(w.DO.Join(table, on...))
}

func (w winHelpInfoDo) LeftJoin(table schema.Tabler, on ...field.Expr) *winHelpInfoDo {
	return w.withDO(w.DO.LeftJoin(table, on...))
}

func (w winHelpInfoDo) RightJoin(table schema.Tabler, on ...field.Expr) *winHelpInfoDo {
	return w.withDO(w.DO.RightJoin(table, on...))
}

func (w winHelpInfoDo) Group(cols ...field.Expr) *winHelpInfoDo {
	return w.withDO(w.DO.Group(cols...))
}

func (w winHelpInfoDo) Having(conds ...gen.Condition) *winHelpInfoDo {
	return w.withDO(w.DO.Having(conds...))
}

func (w winHelpInfoDo) Limit(limit int) *winHelpInfoDo {
	return w.withDO(w.DO.Limit(limit))
}

func (w winHelpInfoDo) Offset(offset int) *winHelpInfoDo {
	return w.withDO(w.DO.Offset(offset))
}

func (w winHelpInfoDo) Scopes(funcs ...func(gen.Dao) gen.Dao) *winHelpInfoDo {
	return w.withDO(w.DO.Scopes(funcs...))
}

func (w winHelpInfoDo) Unscoped() *winHelpInfoDo {
...
func (w winHelpInfoDo) Attrs(attrs ...field.AssignExpr) *winHelpInfoDo {
	return w.withDO(w.DO.Attrs(attrs...))
}

func (w winHelpInfoDo) Assign(attrs ...field.AssignExpr) *winHelpInfoDo {
	return w.withDO(w.DO.Assign(attrs...))
}

func (w winHelpInfoDo) Joins(fields ...field.RelationField) *winHelpInfoDo {
...
func (w winHelpInfoDo) Preload(fields ...field.RelationField) *winHelpInfoDo {
	for _, _f := range fields {
