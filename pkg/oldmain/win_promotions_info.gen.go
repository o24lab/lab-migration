...
func newWinPromotionsInfo(db *gorm.DB, opts ...gen.DOOption) winPromotionsInfo {
	...
	_winPromotionsInfo.ID = field.NewInt32(tableName, "id")
	_winPromotionsInfo.PromotionID = field.NewInt32(tableName, "promotion_id")
	...
	_winPromotionsInfo.CreatedAt = field.NewInt32(tableName, "created_at")
...
func (w winPromotionsInfoDo) Debug() *winPromotionsInfoDo {
	return w.withDO(w.DO.Debug())
}

func (w winPromotionsInfoDo) WithContext(ctx context.Context) *winPromotionsInfoDo {
	return w.withDO(w.DO.WithContext(ctx))
}

func (w winPromotionsInfoDo) ReadDB() *winPromotionsInfoDo {
	return w.Clauses(dbresolver.Read)
}

func (w winPromotionsInfoDo) WriteDB() *winPromotionsInfoDo {
	return w.Clauses(dbresolver.Write)
}

func (w winPromotionsInfoDo) Session(config *gorm.Session) *winPromotionsInfoDo {
	return w.withDO(w.DO.Session(config))
}

func (w winPromotionsInfoDo) Clauses(conds ...clause.Expression) *winPromotionsInfoDo {
	return w.withDO(w.DO.Clauses(conds...))
}

func (w winPromotionsInfoDo) Returning(value interface{}, columns ...string) *winPromotionsInfoDo {
	return w.withDO(w.DO.Returning(value, columns...))
}

func (w winPromotionsInfoDo) Not(conds ...gen.Condition) *winPromotionsInfoDo {
	return w.withDO(w.DO.Not(conds...))
}

func (w winPromotionsInfoDo) Or(conds ...gen.Condition) *winPromotionsInfoDo {
	return w.withDO(w.DO.Or(conds...))
}

func (w winPromotionsInfoDo) Select(conds ...field.Expr) *winPromotionsInfoDo {
	return w.withDO(w.DO.Select(conds...))
}

func (w winPromotionsInfoDo) Where(conds ...gen.Condition) *winPromotionsInfoDo {
	return w.withDO(w.DO.Where(conds...))
}

func (w winPromotionsInfoDo) Order(conds ...field.Expr) *winPromotionsInfoDo {
	return w.withDO(w.DO.Order(conds...))
}

func (w winPromotionsInfoDo) Distinct(cols ...field.Expr) *winPromotionsInfoDo {
	return w.withDO(w.DO.Distinct(cols...))
}

func (w winPromotionsInfoDo) Omit(cols ...field.Expr) *winPromotionsInfoDo {
	return w.withDO(w.DO.Omit(cols...))
}

func (w winPromotionsInfoDo) Join(table schema.Tabler, on ...field.Expr) *winPromotionsInfoDo {
	return w.withDO(w.DO.Join(table, on...))
}

func (w winPromotionsInfoDo) LeftJoin(table schema.Tabler, on ...field.Expr) *winPromotionsInfoDo {
	return w.withDO(w.DO.LeftJoin(table, on...))
}

func (w winPromotionsInfoDo) RightJoin(table schema.Tabler, on ...field.Expr) *winPromotionsInfoDo {
	return w.withDO(w.DO.RightJoin(table, on...))
}

func (w winPromotionsInfoDo) Group(cols ...field.Expr) *winPromotionsInfoDo {
	return w.withDO(w.DO.Group(cols...))
}

func (w winPromotionsInfoDo) Having(conds ...gen.Condition) *winPromotionsInfoDo {
	return w.withDO(w.DO.Having(conds...))
}

func (w winPromotionsInfoDo) Limit(limit int) *winPromotionsInfoDo {
	return w.withDO(w.DO.Limit(limit))
}

func (w winPromotionsInfoDo) Offset(offset int) *winPromotionsInfoDo {
	return w.withDO(w.DO.Offset(offset))
}

func (w winPromotionsInfoDo) Scopes(funcs ...func(gen.Dao) gen.Dao) *winPromotionsInfoDo {
	return w.withDO(w.DO.Scopes(funcs...))
}

func (w winPromotionsInfoDo) Unscoped() *winPromotionsInfoDo {
...
func (w winPromotionsInfoDo) Attrs(attrs ...field.AssignExpr) *winPromotionsInfoDo {
	return w.withDO(w.DO.Attrs(attrs...))
}

func (w winPromotionsInfoDo) Assign(attrs ...field.AssignExpr) *winPromotionsInfoDo {
	return w.withDO(w.DO.Assign(attrs...))
}

func (w winPromotionsInfoDo) Joins(fields ...field.RelationField) *winPromotionsInfoDo {
...
func (w winPromotionsInfoDo) Preload(fields ...field.RelationField) *winPromotionsInfoDo {
	for _, _f := range fields {
