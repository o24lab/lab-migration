...
func newWinUserGoogleCode(db *gorm.DB, opts ...gen.DOOption) winUserGoogleCode {
	...
	_winUserGoogleCode.UID = field.NewInt32(tableName, "uid")
	_winUserGoogleCode.GoogleCode = field.NewString(tableName, "google_code")
	_winUserGoogleCode.Status = field.NewInt32(tableName, "status")
	_winUserGoogleCode.CreatedAt = field.NewInt32(tableName, "created_at")
	_winUserGoogleCode.UpdatedAt = field.NewInt32(tableName, "updated_at")
...
type winUserGoogleCode struct {
	...
	Status     field.Int32  // 状态:1-开启 0-禁用
...
func (w winUserGoogleCodeDo) Debug() *winUserGoogleCodeDo {
	return w.withDO(w.DO.Debug())
}

func (w winUserGoogleCodeDo) WithContext(ctx context.Context) *winUserGoogleCodeDo {
	return w.withDO(w.DO.WithContext(ctx))
}

func (w winUserGoogleCodeDo) ReadDB() *winUserGoogleCodeDo {
	return w.Clauses(dbresolver.Read)
}

func (w winUserGoogleCodeDo) WriteDB() *winUserGoogleCodeDo {
	return w.Clauses(dbresolver.Write)
}

func (w winUserGoogleCodeDo) Session(config *gorm.Session) *winUserGoogleCodeDo {
	return w.withDO(w.DO.Session(config))
}

func (w winUserGoogleCodeDo) Clauses(conds ...clause.Expression) *winUserGoogleCodeDo {
	return w.withDO(w.DO.Clauses(conds...))
}

func (w winUserGoogleCodeDo) Returning(value interface{}, columns ...string) *winUserGoogleCodeDo {
	return w.withDO(w.DO.Returning(value, columns...))
}

func (w winUserGoogleCodeDo) Not(conds ...gen.Condition) *winUserGoogleCodeDo {
	return w.withDO(w.DO.Not(conds...))
}

func (w winUserGoogleCodeDo) Or(conds ...gen.Condition) *winUserGoogleCodeDo {
	return w.withDO(w.DO.Or(conds...))
}

func (w winUserGoogleCodeDo) Select(conds ...field.Expr) *winUserGoogleCodeDo {
	return w.withDO(w.DO.Select(conds...))
}

func (w winUserGoogleCodeDo) Where(conds ...gen.Condition) *winUserGoogleCodeDo {
	return w.withDO(w.DO.Where(conds...))
}

func (w winUserGoogleCodeDo) Order(conds ...field.Expr) *winUserGoogleCodeDo {
	return w.withDO(w.DO.Order(conds...))
}

func (w winUserGoogleCodeDo) Distinct(cols ...field.Expr) *winUserGoogleCodeDo {
	return w.withDO(w.DO.Distinct(cols...))
}

func (w winUserGoogleCodeDo) Omit(cols ...field.Expr) *winUserGoogleCodeDo {
	return w.withDO(w.DO.Omit(cols...))
}

func (w winUserGoogleCodeDo) Join(table schema.Tabler, on ...field.Expr) *winUserGoogleCodeDo {
	return w.withDO(w.DO.Join(table, on...))
}

func (w winUserGoogleCodeDo) LeftJoin(table schema.Tabler, on ...field.Expr) *winUserGoogleCodeDo {
	return w.withDO(w.DO.LeftJoin(table, on...))
}

func (w winUserGoogleCodeDo) RightJoin(table schema.Tabler, on ...field.Expr) *winUserGoogleCodeDo {
	return w.withDO(w.DO.RightJoin(table, on...))
}

func (w winUserGoogleCodeDo) Group(cols ...field.Expr) *winUserGoogleCodeDo {
	return w.withDO(w.DO.Group(cols...))
}

func (w winUserGoogleCodeDo) Having(conds ...gen.Condition) *winUserGoogleCodeDo {
	return w.withDO(w.DO.Having(conds...))
}

func (w winUserGoogleCodeDo) Limit(limit int) *winUserGoogleCodeDo {
	return w.withDO(w.DO.Limit(limit))
}

func (w winUserGoogleCodeDo) Offset(offset int) *winUserGoogleCodeDo {
	return w.withDO(w.DO.Offset(offset))
}

func (w winUserGoogleCodeDo) Scopes(funcs ...func(gen.Dao) gen.Dao) *winUserGoogleCodeDo {
	return w.withDO(w.DO.Scopes(funcs...))
}

func (w winUserGoogleCodeDo) Unscoped() *winUserGoogleCodeDo {
...
func (w winUserGoogleCodeDo) Attrs(attrs ...field.AssignExpr) *winUserGoogleCodeDo {
	return w.withDO(w.DO.Attrs(attrs...))
}

func (w winUserGoogleCodeDo) Assign(attrs ...field.AssignExpr) *winUserGoogleCodeDo {
	return w.withDO(w.DO.Assign(attrs...))
}

func (w winUserGoogleCodeDo) Joins(fields ...field.RelationField) *winUserGoogleCodeDo {
...
func (w winUserGoogleCodeDo) Preload(fields ...field.RelationField) *winUserGoogleCodeDo {
	for _, _f := range fields {
