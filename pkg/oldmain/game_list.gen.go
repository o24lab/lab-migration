...
func newGameList(db *gorm.DB, opts ...gen.DOOption) gameList {
	...
	_gameList.ID = field.NewInt32(tableName, "id")
	_gameList.Code = field.NewString(tableName, "code")
	_gameList.GameProviderSubtypeID = field.NewInt32(tableName, "game_provider_subtype_id")
	_gameList.GamePagcorID = field.NewInt32(tableName, "game_pagcor_id")
	_gameList.GameTypeID = field.NewInt32(tableName, "game_type_id")
	_gameList.GameProviderID = field.NewInt32(tableName, "game_provider_id")
	_gameList.GameStartParam = field.NewString(tableName, "game_start_param")
	_gameList.Sort = field.NewInt32(tableName, "sort")
	_gameList.Status = field.NewInt32(tableName, "status")
	...
	_gameList.IsNew = field.NewInt32(tableName, "is_new")
	_gameList.FavoriteStar = field.NewInt32(tableName, "favorite_star")
	_gameList.HotStar = field.NewInt32(tableName, "hot_star")
	_gameList.Device = field.NewInt32(tableName, "device")
	_gameList.CreatedAt = field.NewInt32(tableName, "created_at")
	_gameList.UpdatedAt = field.NewInt32(tableName, "updated_at")
...
type gameList struct {
	...
	GameProviderSubtypeID field.Int32  // 关联game_provider_subtype表ID
	GamePagcorID          field.Int32  // pagcor类型id
	GameTypeID            field.Int32  // 游戏类型id
	...
	IsNew                 field.Int32  // 是否新游戏:1-是 0-否
	FavoriteStar          field.Int32  // 收藏值
	HotStar               field.Int32  // 热度
	Device                field.Int32  // 设备:0-all 1-pc 2-h5
...
func (g *gameList) updateTableName(table string) *gameList {
	...
	g.GameProviderSubtypeID = field.NewInt32(table, "game_provider_subtype_id")
	g.GamePagcorID = field.NewInt32(table, "game_pagcor_id")
	...
	g.FavoriteStar = field.NewInt32(table, "favorite_star")
	g.HotStar = field.NewInt32(table, "hot_star")
	g.Device = field.NewInt32(table, "device")
...
func (g gameListDo) Debug() *gameListDo {
	return g.withDO(g.DO.Debug())
}

func (g gameListDo) WithContext(ctx context.Context) *gameListDo {
	return g.withDO(g.DO.WithContext(ctx))
}

func (g gameListDo) ReadDB() *gameListDo {
	return g.Clauses(dbresolver.Read)
}

func (g gameListDo) WriteDB() *gameListDo {
	return g.Clauses(dbresolver.Write)
}

func (g gameListDo) Session(config *gorm.Session) *gameListDo {
	return g.withDO(g.DO.Session(config))
}

func (g gameListDo) Clauses(conds ...clause.Expression) *gameListDo {
	return g.withDO(g.DO.Clauses(conds...))
}

func (g gameListDo) Returning(value interface{}, columns ...string) *gameListDo {
	return g.withDO(g.DO.Returning(value, columns...))
}

func (g gameListDo) Not(conds ...gen.Condition) *gameListDo {
	return g.withDO(g.DO.Not(conds...))
}

func (g gameListDo) Or(conds ...gen.Condition) *gameListDo {
	return g.withDO(g.DO.Or(conds...))
}

func (g gameListDo) Select(conds ...field.Expr) *gameListDo {
	return g.withDO(g.DO.Select(conds...))
}

func (g gameListDo) Where(conds ...gen.Condition) *gameListDo {
	return g.withDO(g.DO.Where(conds...))
}

func (g gameListDo) Order(conds ...field.Expr) *gameListDo {
	return g.withDO(g.DO.Order(conds...))
}

func (g gameListDo) Distinct(cols ...field.Expr) *gameListDo {
	return g.withDO(g.DO.Distinct(cols...))
}

func (g gameListDo) Omit(cols ...field.Expr) *gameListDo {
	return g.withDO(g.DO.Omit(cols...))
}

func (g gameListDo) Join(table schema.Tabler, on ...field.Expr) *gameListDo {
	return g.withDO(g.DO.Join(table, on...))
}

func (g gameListDo) LeftJoin(table schema.Tabler, on ...field.Expr) *gameListDo {
	return g.withDO(g.DO.LeftJoin(table, on...))
}

func (g gameListDo) RightJoin(table schema.Tabler, on ...field.Expr) *gameListDo {
	return g.withDO(g.DO.RightJoin(table, on...))
}

func (g gameListDo) Group(cols ...field.Expr) *gameListDo {
	return g.withDO(g.DO.Group(cols...))
}

func (g gameListDo) Having(conds ...gen.Condition) *gameListDo {
	return g.withDO(g.DO.Having(conds...))
}

func (g gameListDo) Limit(limit int) *gameListDo {
	return g.withDO(g.DO.Limit(limit))
}

func (g gameListDo) Offset(offset int) *gameListDo {
	return g.withDO(g.DO.Offset(offset))
}

func (g gameListDo) Scopes(funcs ...func(gen.Dao) gen.Dao) *gameListDo {
	return g.withDO(g.DO.Scopes(funcs...))
}

func (g gameListDo) Unscoped() *gameListDo {
...
func (g gameListDo) Attrs(attrs ...field.AssignExpr) *gameListDo {
	return g.withDO(g.DO.Attrs(attrs...))
}

func (g gameListDo) Assign(attrs ...field.AssignExpr) *gameListDo {
	return g.withDO(g.DO.Assign(attrs...))
}

func (g gameListDo) Joins(fields ...field.RelationField) *gameListDo {
...
func (g gameListDo) Preload(fields ...field.RelationField) *gameListDo {
	for _, _f := range fields {
