...
func newXxlJobRegistry(db *gorm.DB, opts ...gen.DOOption) xxlJobRegistry {
	...
	_xxlJobRegistry.ID = field.NewInt32(tableName, "id")
...
func (x xxlJobRegistryDo) Debug() *xxlJobRegistryDo {
	return x.withDO(x.DO.Debug())
}

func (x xxlJobRegistryDo) WithContext(ctx context.Context) *xxlJobRegistryDo {
	return x.withDO(x.DO.WithContext(ctx))
}

func (x xxlJobRegistryDo) ReadDB() *xxlJobRegistryDo {
	return x.Clauses(dbresolver.Read)
}

func (x xxlJobRegistryDo) WriteDB() *xxlJobRegistryDo {
	return x.Clauses(dbresolver.Write)
}

func (x xxlJobRegistryDo) Session(config *gorm.Session) *xxlJobRegistryDo {
	return x.withDO(x.DO.Session(config))
}

func (x xxlJobRegistryDo) Clauses(conds ...clause.Expression) *xxlJobRegistryDo {
	return x.withDO(x.DO.Clauses(conds...))
}

func (x xxlJobRegistryDo) Returning(value interface{}, columns ...string) *xxlJobRegistryDo {
	return x.withDO(x.DO.Returning(value, columns...))
}

func (x xxlJobRegistryDo) Not(conds ...gen.Condition) *xxlJobRegistryDo {
	return x.withDO(x.DO.Not(conds...))
}

func (x xxlJobRegistryDo) Or(conds ...gen.Condition) *xxlJobRegistryDo {
	return x.withDO(x.DO.Or(conds...))
}

func (x xxlJobRegistryDo) Select(conds ...field.Expr) *xxlJobRegistryDo {
	return x.withDO(x.DO.Select(conds...))
}

func (x xxlJobRegistryDo) Where(conds ...gen.Condition) *xxlJobRegistryDo {
	return x.withDO(x.DO.Where(conds...))
}

func (x xxlJobRegistryDo) Order(conds ...field.Expr) *xxlJobRegistryDo {
	return x.withDO(x.DO.Order(conds...))
}

func (x xxlJobRegistryDo) Distinct(cols ...field.Expr) *xxlJobRegistryDo {
	return x.withDO(x.DO.Distinct(cols...))
}

func (x xxlJobRegistryDo) Omit(cols ...field.Expr) *xxlJobRegistryDo {
	return x.withDO(x.DO.Omit(cols...))
}

func (x xxlJobRegistryDo) Join(table schema.Tabler, on ...field.Expr) *xxlJobRegistryDo {
	return x.withDO(x.DO.Join(table, on...))
}

func (x xxlJobRegistryDo) LeftJoin(table schema.Tabler, on ...field.Expr) *xxlJobRegistryDo {
	return x.withDO(x.DO.LeftJoin(table, on...))
}

func (x xxlJobRegistryDo) RightJoin(table schema.Tabler, on ...field.Expr) *xxlJobRegistryDo {
	return x.withDO(x.DO.RightJoin(table, on...))
}

func (x xxlJobRegistryDo) Group(cols ...field.Expr) *xxlJobRegistryDo {
	return x.withDO(x.DO.Group(cols...))
}

func (x xxlJobRegistryDo) Having(conds ...gen.Condition) *xxlJobRegistryDo {
	return x.withDO(x.DO.Having(conds...))
}

func (x xxlJobRegistryDo) Limit(limit int) *xxlJobRegistryDo {
	return x.withDO(x.DO.Limit(limit))
}

func (x xxlJobRegistryDo) Offset(offset int) *xxlJobRegistryDo {
	return x.withDO(x.DO.Offset(offset))
}

func (x xxlJobRegistryDo) Scopes(funcs ...func(gen.Dao) gen.Dao) *xxlJobRegistryDo {
	return x.withDO(x.DO.Scopes(funcs...))
}

func (x xxlJobRegistryDo) Unscoped() *xxlJobRegistryDo {
...
func (x xxlJobRegistryDo) Attrs(attrs ...field.AssignExpr) *xxlJobRegistryDo {
	return x.withDO(x.DO.Attrs(attrs...))
}

func (x xxlJobRegistryDo) Assign(attrs ...field.AssignExpr) *xxlJobRegistryDo {
	return x.withDO(x.DO.Assign(attrs...))
}

func (x xxlJobRegistryDo) Joins(fields ...field.RelationField) *xxlJobRegistryDo {
...
func (x xxlJobRegistryDo) Preload(fields ...field.RelationField) *xxlJobRegistryDo {
	for _, _f := range fields {
