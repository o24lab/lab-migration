...
func newWinNoticeStatus(db *gorm.DB, opts ...gen.DOOption) winNoticeStatus {
	...
	_winNoticeStatus.ID = field.NewInt32(tableName, "id")
	_winNoticeStatus.UID = field.NewInt32(tableName, "uid")
	_winNoticeStatus.NoticeID = field.NewInt64(tableName, "notice_id")
	_winNoticeStatus.IsRead = field.NewInt32(tableName, "is_read")
	_winNoticeStatus.IsDelete = field.NewInt32(tableName, "is_delete")
	_winNoticeStatus.CreateAt = field.NewInt32(tableName, "create_at")
	_winNoticeStatus.UpdateAt = field.NewInt32(tableName, "update_at")
	_winNoticeStatus.Category = field.NewInt32(tableName, "category")
...
type winNoticeStatus struct {
	...
	IsRead   field.Int32 // 0-未读1-已读
	IsDelete field.Int32 // 0-未删除1-删除
	CreateAt field.Int32 // 创建时间
	UpdateAt field.Int32 // 创基时间
	Category field.Int32 // 类型:1-系统公告2-站内信 3-系统消息
...
func (w *winNoticeStatus) updateTableName(table string) *winNoticeStatus {
	...
	w.IsRead = field.NewInt32(table, "is_read")
	w.IsDelete = field.NewInt32(table, "is_delete")
	w.CreateAt = field.NewInt32(table, "create_at")
	w.UpdateAt = field.NewInt32(table, "update_at")
...
func (w winNoticeStatusDo) Debug() *winNoticeStatusDo {
	return w.withDO(w.DO.Debug())
}

func (w winNoticeStatusDo) WithContext(ctx context.Context) *winNoticeStatusDo {
	return w.withDO(w.DO.WithContext(ctx))
}

func (w winNoticeStatusDo) ReadDB() *winNoticeStatusDo {
	return w.Clauses(dbresolver.Read)
}

func (w winNoticeStatusDo) WriteDB() *winNoticeStatusDo {
	return w.Clauses(dbresolver.Write)
}

func (w winNoticeStatusDo) Session(config *gorm.Session) *winNoticeStatusDo {
	return w.withDO(w.DO.Session(config))
}

func (w winNoticeStatusDo) Clauses(conds ...clause.Expression) *winNoticeStatusDo {
	return w.withDO(w.DO.Clauses(conds...))
}

func (w winNoticeStatusDo) Returning(value interface{}, columns ...string) *winNoticeStatusDo {
	return w.withDO(w.DO.Returning(value, columns...))
}

func (w winNoticeStatusDo) Not(conds ...gen.Condition) *winNoticeStatusDo {
	return w.withDO(w.DO.Not(conds...))
}

func (w winNoticeStatusDo) Or(conds ...gen.Condition) *winNoticeStatusDo {
	return w.withDO(w.DO.Or(conds...))
}

func (w winNoticeStatusDo) Select(conds ...field.Expr) *winNoticeStatusDo {
	return w.withDO(w.DO.Select(conds...))
}

func (w winNoticeStatusDo) Where(conds ...gen.Condition) *winNoticeStatusDo {
	return w.withDO(w.DO.Where(conds...))
}

func (w winNoticeStatusDo) Order(conds ...field.Expr) *winNoticeStatusDo {
	return w.withDO(w.DO.Order(conds...))
}

func (w winNoticeStatusDo) Distinct(cols ...field.Expr) *winNoticeStatusDo {
	return w.withDO(w.DO.Distinct(cols...))
}

func (w winNoticeStatusDo) Omit(cols ...field.Expr) *winNoticeStatusDo {
	return w.withDO(w.DO.Omit(cols...))
}

func (w winNoticeStatusDo) Join(table schema.Tabler, on ...field.Expr) *winNoticeStatusDo {
	return w.withDO(w.DO.Join(table, on...))
}

func (w winNoticeStatusDo) LeftJoin(table schema.Tabler, on ...field.Expr) *winNoticeStatusDo {
	return w.withDO(w.DO.LeftJoin(table, on...))
}

func (w winNoticeStatusDo) RightJoin(table schema.Tabler, on ...field.Expr) *winNoticeStatusDo {
	return w.withDO(w.DO.RightJoin(table, on...))
}

func (w winNoticeStatusDo) Group(cols ...field.Expr) *winNoticeStatusDo {
	return w.withDO(w.DO.Group(cols...))
}

func (w winNoticeStatusDo) Having(conds ...gen.Condition) *winNoticeStatusDo {
	return w.withDO(w.DO.Having(conds...))
}

func (w winNoticeStatusDo) Limit(limit int) *winNoticeStatusDo {
	return w.withDO(w.DO.Limit(limit))
}

func (w winNoticeStatusDo) Offset(offset int) *winNoticeStatusDo {
	return w.withDO(w.DO.Offset(offset))
}

func (w winNoticeStatusDo) Scopes(funcs ...func(gen.Dao) gen.Dao) *winNoticeStatusDo {
	return w.withDO(w.DO.Scopes(funcs...))
}

func (w winNoticeStatusDo) Unscoped() *winNoticeStatusDo {
...
func (w winNoticeStatusDo) Attrs(attrs ...field.AssignExpr) *winNoticeStatusDo {
	return w.withDO(w.DO.Attrs(attrs...))
}

func (w winNoticeStatusDo) Assign(attrs ...field.AssignExpr) *winNoticeStatusDo {
	return w.withDO(w.DO.Assign(attrs...))
}

func (w winNoticeStatusDo) Joins(fields ...field.RelationField) *winNoticeStatusDo {
...
func (w winNoticeStatusDo) Preload(fields ...field.RelationField) *winNoticeStatusDo {
	for _, _f := range fields {
