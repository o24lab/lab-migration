...
type WinUserLevel struct {
	...
	ScoreUpgradeMin  int32  `gorm:"column:score_upgrade_min" json:"score_upgrade_min"`
	ScoreUpgradeMax  int32  `gorm:"column:score_upgrade_max" json:"score_upgrade_max"`
	ScoreUpgradeRate int32  `gorm:"column:score_upgrade_rate;default:1" json:"score_upgrade_rate"`
}
