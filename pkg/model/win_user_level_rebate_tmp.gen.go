...
const TableNameWinUserLevelRebateTmp = "win_user_level_rebate_tmp"
...
// TableName WinUserLevelRebateTmp's table name
func (*WinUserLevelRebateTmp) TableName() string {
	return TableNameWinUserLevelRebateTmp
}
