...
const TableNameWinUserRebateSet = "win_user_rebate_set"
...
// TableName WinUserRebateSet's table name
func (*WinUserRebateSet) TableName() string {
	return TableNameWinUserRebateSet
}
